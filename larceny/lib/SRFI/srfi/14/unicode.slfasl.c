/* Generated from /home/henchman/larcenytest/larceny-petit-Nightly-2017-08-06/larceny_src/lib/SRFI/srfi/14/unicode.slfasl */
...
static RTYPE compiled_start_1_0( CONT_PARAMS ) {
  ...
  twobit_setglbl( 2 ); /*  char-set:ascii~1pxGHH~14270 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 3 ); /*  char-set:iso-control~1pxGHH~14269 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 4 ); /*  char-set:blank~1pxGHH~14268 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 5 ); /*  char-set:printing~1pxGHH~14267 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 6 ); /*  char-set:whitespace~1pxGHH~14266 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 7 ); /*  char-set:graphic~1pxGHH~14265 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 8 ); /*  char-set:symbol~1pxGHH~14264 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 9 ); /*  char-set:punctuation~1pxGHH~14263 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 10 ); /*  char-set:letter+digit~1pxGHH~14262 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 11 ); /*  char-set:hex-digit~1pxGHH~14261 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 12 ); /*  char-set:digit~1pxGHH~14260 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 13 ); /*  char-set:letter~1pxGHH~14259 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 14 ); /*  char-set:title-case~1pxGHH~14258 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 15 ); /*  char-set:upper-case~1pxGHH~14257 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 16 ); /*  char-set:lower-case~1pxGHH~14256 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 17 ); /*  char-set:full~1pxGHH~14255 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 18 ); /*  char-set:empty~1pxGHH~14254 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 19 ); /*  char-set-diff+intersection~1pxGHH~14253 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 20 ); /*  char-set-diff+intersection!~1pxGHH~14252 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 21 ); /*  char-set-xor~1pxGHH~14251 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 22 ); /*  char-set-xor!~1pxGHH~14250 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 23 ); /*  char-set-difference~1pxGHH~14249 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 24 ); /*  char-set-difference!~1pxGHH~14248 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 25 ); /*  char-set-intersection~1pxGHH~14247 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 26 ); /*  char-set-intersection!~1pxGHH~14246 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 27 ); /*  char-set-union~1pxGHH~14245 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 28 ); /*  char-set-union!~1pxGHH~14244 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 29 ); /*  char-set-complement!~1pxGHH~14243 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 30 ); /*  char-set-complement~1pxGHH~14242 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 31 ); /*  ->char-set~1pxGHH~14241 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 32 ); /*  char-set-filter!~1pxGHH~14240 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 33 ); /*  char-set-filter~1pxGHH~14239 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 34 ); /*  %char-set-filter~1pxGHH~14238 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 35 ); /*  ucs-range->char-set!~1pxGHH~14237 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 36 ); /*  ucs-range->char-set~1pxGHH~14236 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 37 ); /*  %ucs-range->char-set~1pxGHH~14235 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 38 ); /*  char-set->string~1pxGHH~14234 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 39 ); /*  string->char-set!~1pxGHH~14233 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 40 ); /*  string->char-set~1pxGHH~14232 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 41 ); /*  %string->char-set~1pxGHH~14231 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 42 ); /*  char-set->list~1pxGHH~14230 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 43 ); /*  list->char-set!~1pxGHH~14229 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 44 ); /*  list->char-set~1pxGHH~14228 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 45 ); /*  char-set~1pxGHH~14227 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 46 ); /*  %list->char-set~1pxGHH~14226 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 47 ); /*  char-set-unfold!~1pxGHH~14225 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 48 ); /*  char-set-unfold~1pxGHH~14224 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 49 ); /*  %char-set-unfold~1pxGHH~14223 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 50 ); /*  char-set-any~1pxGHH~14222 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 51 ); /*  char-set-every~1pxGHH~14221 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 52 ); /*  char-set-fold~1pxGHH~14220 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 53 ); /*  char-set-map~1pxGHH~14219 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 54 ); /*  char-set-for-each~1pxGHH~14218 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 55 ); /*  %char-set-cursor-next~1pxGHH~14217 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 56 ); /*  char-set-cursor-next~1pxGHH~14216 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 57 ); /*  char-set-ref~1pxGHH~14215 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 58 ); /*  end-of-char-set?~1pxGHH~14214 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 59 ); /*  char-set-cursor~1pxGHH~14213 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 60 ); /*  char-set-delete!~1pxGHH~14212 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 61 ); /*  char-set-delete~1pxGHH~14211 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 62 ); /*  char-set-adjoin!~1pxGHH~14210 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 63 ); /*  char-set-adjoin~1pxGHH~14209 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 64 ); /*  char-set-count~1pxGHH~14208 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 65 ); /*  char-set-size~1pxGHH~14207 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 66 ); /*  char-set-contains?~1pxGHH~14206 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 67 ); /*  char-set-hash~1pxGHH~14205 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 68 ); /*  char-set<=~1pxGHH~14204 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 69 ); /*  char-set=~1pxGHH~14203 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 70 ); /*  char-set-copy~1pxGHH~14202 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 71 ); /*  %set1!~1pxGHH~14201 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 72 ); /*  %set0!~1pxGHH~14200 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 73 ); /*  si=1?~1pxGHH~14199 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 74 ); /*  si=0?~1pxGHH~14198 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 75 ); /*  %char-set:bitv/check~1pxGHH~14197 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 76 ); /*  %default-base~1pxGHH~14196 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 77 ); /*  %char-set:empty~1pxGHH~14175 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 78 ); /*  char-set:bitv~1pxGHH~14174 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 79 ); /*  char-set?~1pxGHH~14173 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 80 ); /*  make-char-set~1pxGHH~14172 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 81 ); /*  :char-set~1pxGHH~14171 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 82 ); /*  error~1pxGHH~14166 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 83 ); /*  bitvector-set!~1pxGHH~14165 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 84 ); /*  bitvector-ref~1pxGHH~14164 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 85 ); /*  bitvector-length~1pxGHH~14163 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 86 ); /*  make-bitvector~1pxGHH~14162 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 87 ); /*  bitvector-minimized~1pxGHH~14161 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 88 ); /*  %char-set:maxsize-in-bytes~1pxGHH~14160 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 89 ); /*  %char-set:maxsize~1pxGHH~14159 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 90 ); /*  %char-set:minsize-in-bytes~1pxGHH~14158 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 91 ); /*  %char-set:minsize~1pxGHH~14157 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 92 ); /*  %excluded:max/8~1pxGHH~14156 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 93 ); /*  %excluded:min/8~1pxGHH~14155 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 94 ); /*  %unicode:limit~1pxGHH~14154 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 95 ); /*  %excluded:max~1pxGHH~14153 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 96 ); /*  %excluded:min~1pxGHH~14152 */
  twobit_lambda( compiled_start_1_1, 98, 0 );
  twobit_setreg( 2 );
  twobit_lambda( compiled_start_1_2, 100, 0 );
  twobit_setreg( 4 );
  twobit_lambda( compiled_start_1_3, 102, 0 );
  twobit_setreg( 3 );
  twobit_movereg( 3, 7 );
  twobit_movereg( 4, 6 );
  twobit_const( 103 );
...
static RTYPE compiled_start_1_2( CONT_PARAMS ) {
  ...
  twobit_save( 0 );
  twobit_store( 0, 0 );
  twobit_lambda( compiled_start_1_210, 2, 0 );
  twobit_setreg( 2 );
  twobit_const( 3 );
  twobit_setreg( 1 );
...
static RTYPE compiled_start_1_3( CONT_PARAMS ) {
  ...
  twobit_global( 1 ); /* ex:undefined */
  twobit_setglbl( 96 ); /*  %excluded:min~1pxGHH~14152 */
  twobit_lambda( compiled_start_1_4, 98, 0 );
  twobit_setreg( 4 );
  twobit_store( 4, 93 );
  ...
  twobit_setreg( 4 );
  twobit_imm_const( fixnum(55296) ); /* 55296 */
  twobit_op2_65( 4, 5, compiled_temp_1_5 ); /* quotient */
  twobit_setreg( 4 );
  twobit_store( 4, 3 );
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_setreg( 4 );
  twobit_imm_const( fixnum(57343) ); /* 57343 */
  twobit_op2_65( 4, 6, compiled_temp_1_6 ); /* quotient */
  twobit_setreg( 4 );
  twobit_reg( 3 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_7, 100, 0 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_movereg( 2, 1 );
  twobit_lambda( compiled_start_1_8, 102, 1 );
  twobit_setreg( 4 );
  twobit_stack( 60 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_9, 104, 0 );
  twobit_setreg( 4 );
  twobit_stack( 59 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 1, 59 );
  twobit_lambda( compiled_start_1_10, 106, 1 );
  twobit_setreg( 4 );
  twobit_stack( 58 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 1, 60 );
  twobit_lambda( compiled_start_1_11, 108, 1 );
  twobit_setreg( 4 );
  twobit_stack( 57 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 2, 56 );
  twobit_load( 1, 55 );
  twobit_lambda( compiled_start_1_12, 110, 2 );
  twobit_setreg( 4 );
  twobit_stack( 54 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_13, 112, 0 );
  twobit_setreg( 4 );
  twobit_stack( 53 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_14, 114, 0 );
  twobit_setreg( 4 );
  twobit_stack( 52 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_15, 116, 0 );
  twobit_setreg( 4 );
  twobit_reg( 1 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_16, 118, 0 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_const( 119 );
  ...
  twobit_const( 122 );
  twobit_setreg( 2 );
  twobit_global( 123 ); /* rtd-constructor */
  ...
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 1 );
  twobit_global( 124 ); /* rtd-predicate */
  ...
  twobit_const( 125 );
  twobit_setreg( 2 );
  twobit_global( 126 ); /* rtd-accessor */
  ...
  twobit_load( 2, 49 );
  twobit_load( 1, 46 );
  twobit_lambda( compiled_start_1_17, 128, 3 );
  twobit_setreg( 4 );
  twobit_stack( 45 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 1, 48 );
  twobit_lambda( compiled_start_1_18, 130, 3 );
  twobit_setreg( 4 );
  twobit_stack( 44 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 2, 47 );
  twobit_load( 1, 52 );
  twobit_lambda( compiled_start_1_19, 132, 2 );
  twobit_setreg( 4 );
  twobit_stack( 43 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_20, 134, 2 );
  twobit_setreg( 4 );
  twobit_stack( 42 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 1, 55 );
  twobit_lambda( compiled_start_1_21, 136, 1 );
  twobit_setreg( 4 );
  twobit_stack( 41 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_22, 138, 1 );
  twobit_setreg( 4 );
  twobit_stack( 40 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_23, 140, 0 );
  twobit_setreg( 4 );
  twobit_stack( 39 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 2, 38 );
  twobit_load( 1, 44 );
  twobit_lambda( compiled_start_1_24, 142, 2 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 2, 37 );
  twobit_lambda( compiled_start_1_25, 144, 2 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 2, 36 );
  twobit_lambda( compiled_start_1_26, 146, 2 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 3, 35 );
  twobit_load( 2, 42 );
  twobit_lambda( compiled_start_1_27, 148, 3 );
  twobit_setreg( 4 );
  twobit_reg( 3 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 2, 34 );
  twobit_lambda( compiled_start_1_28, 150, 2 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 3, 42 );
  twobit_load( 2, 33 );
  twobit_lambda( compiled_start_1_29, 152, 3 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 2, 32 );
  twobit_load( 1, 25 );
  twobit_lambda( compiled_start_1_30, 154, 2 );
  twobit_setreg( 4 );
  twobit_stack( 31 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_31, 156, 2 );
  twobit_setreg( 4 );
  twobit_stack( 30 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 1, 21 );
  twobit_lambda( compiled_start_1_32, 158, 2 );
  twobit_setreg( 4 );
  twobit_stack( 29 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_33, 160, 2 );
  twobit_setreg( 4 );
  twobit_stack( 28 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 2, 27 );
  twobit_load( 1, 26 );
  twobit_lambda( compiled_start_1_34, 162, 2 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_35, 164, 0 );
  twobit_setreg( 4 );
  twobit_stack( 24 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_36, 166, 0 );
  twobit_setreg( 4 );
  twobit_stack( 23 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 2, 22 );
  twobit_lambda( compiled_start_1_37, 168, 2 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 1, 44 );
  twobit_lambda( compiled_start_1_38, 170, 1 );
  twobit_setreg( 4 );
  twobit_stack( 26 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 4, 24 );
  twobit_load( 3, 23 );
  twobit_load( 1, 27 );
  twobit_lambda( compiled_start_1_39, 172, 4 );
  twobit_setreg( 4 );
  twobit_stack( 20 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 5, 24 );
  twobit_load( 4, 32 );
  twobit_lambda( compiled_start_1_40, 174, 5 );
  twobit_setreg( 4 );
  twobit_stack( 19 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_movereg( 5, 4 );
  twobit_lambda( compiled_start_1_41, 176, 4 );
  twobit_setreg( 4 );
  twobit_stack( 18 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_movereg( 5, 4 );
  twobit_lambda( compiled_start_1_42, 178, 4 );
  twobit_setreg( 4 );
  twobit_stack( 17 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_movereg( 5, 4 );
  twobit_lambda( compiled_start_1_43, 180, 4 );
  twobit_setreg( 4 );
  twobit_stack( 16 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 2, 32 );
  twobit_load( 1, 15 );
  twobit_lambda( compiled_start_1_44, 182, 2 );
  twobit_setreg( 4 );
  twobit_stack( 14 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 3, 45 );
  twobit_load( 2, 13 );
  twobit_load( 1, 14 );
  twobit_lambda( compiled_start_1_45, 184, 3 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 2, 12 );
  twobit_lambda( compiled_start_1_46, 186, 2 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 4, 32 );
  ...
  twobit_load( 2, 40 );
  twobit_load( 1, 50 );
  twobit_lambda( compiled_start_1_47, 188, 4 );
  twobit_setreg( 2 );
  twobit_stack( 11 );
  twobit_op2_84( 2 ); /* cell-set! */
  twobit_load( 2, 46 );
  twobit_load( 1, 11 );
  twobit_lambda( compiled_start_1_48, 190, 2 );
  twobit_setreg( 4 );
  twobit_stack( 10 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 3, 32 );
  twobit_load( 2, 45 );
  twobit_lambda( compiled_start_1_49, 192, 3 );
  twobit_setreg( 4 );
  twobit_reg( 3 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_50, 194, 1 );
  twobit_setreg( 4 );
  twobit_stack( 9 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_movereg( 5, 4 );
  ...
  twobit_load( 2, 23 );
  twobit_load( 1, 27 );
  twobit_lambda( compiled_start_1_51, 196, 4 );
  twobit_setreg( 4 );
  twobit_stack( 15 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 1, 32 );
  twobit_lambda( compiled_start_1_52, 198, 1 );
  twobit_setreg( 4 );
  twobit_stack( 8 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 3, 45 );
  twobit_load( 2, 7 );
  twobit_load( 1, 8 );
  twobit_lambda( compiled_start_1_53, 200, 3 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_54, 202, 1 );
  twobit_setreg( 4 );
  twobit_stack( 6 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 1, 15 );
  twobit_lambda( compiled_start_1_55, 204, 1 );
  twobit_setreg( 4 );
  twobit_stack( 5 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 9, 4 );
  ...
  twobit_load( 2, 44 );
  twobit_load( 1, 50 );
  twobit_lambda( compiled_start_1_56, 206, 9 );
  twobit_setreg( 4 );
  twobit_reg( 5 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 3, 45 );
  twobit_load( 2, 1 );
  twobit_movereg( 5, 1 );
  twobit_lambda( compiled_start_1_57, 208, 3 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 2, 61 );
  twobit_movereg( 5, 1 );
  twobit_lambda( compiled_start_1_58, 210, 2 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 5, 44 );
  ...
  twobit_load( 2, 57 );
  twobit_load( 1, 50 );
  twobit_lambda( compiled_start_1_59, 212, 5 );
  twobit_setreg( 4 );
  twobit_stack( 62 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 3, 45 );
  twobit_load( 2, 63 );
  twobit_load( 1, 62 );
  twobit_lambda( compiled_start_1_60, 214, 3 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 2, 64 );
  twobit_lambda( compiled_start_1_61, 216, 2 );
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 4, 49 );
  ...
  twobit_load( 2, 10 );
  twobit_load( 1, 56 );
  twobit_lambda( compiled_start_1_62, 218, 4 );
  twobit_setreg( 1 );
  twobit_stack( 65 );
  twobit_op2_84( 1 ); /* cell-set! */
  twobit_load( 2, 66 );
  twobit_load( 1, 21 );
  twobit_lambda( compiled_start_1_63, 220, 2 );
  twobit_setreg( 4 );
  twobit_stack( 67 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_64, 222, 2 );
  twobit_setreg( 4 );
  twobit_stack( 68 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 1, 25 );
  twobit_lambda( compiled_start_1_65, 224, 1 );
  twobit_setreg( 4 );
  twobit_stack( 69 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_movereg( 6, 4 );
  twobit_movereg( 5, 3 );
  twobit_load( 2, 50 );
  twobit_lambda( compiled_start_1_66, 226, 4 );
  twobit_setreg( 4 );
  twobit_reg( 1 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 1, 70 );
  twobit_lambda( compiled_start_1_67, 228, 1 );
  twobit_setreg( 4 );
  twobit_stack( 71 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 4, 66 );
  twobit_load( 3, 57 );
  twobit_lambda( compiled_start_1_68, 230, 5 );
  twobit_setreg( 4 );
  twobit_reg( 1 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_load( 1, 21 );
  twobit_lambda( compiled_start_1_69, 232, 1 );
  twobit_setreg( 4 );
  twobit_stack( 72 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_movereg( 5, 4 );
  twobit_lambda( compiled_start_1_70, 234, 4 );
  twobit_setreg( 3 );
  twobit_reg( 1 );
  twobit_op2_84( 3 ); /* cell-set! */
  twobit_load( 1, 73 );
  twobit_lambda( compiled_start_1_71, 236, 1 );
  twobit_setreg( 3 );
  twobit_stack( 74 );
  twobit_op2_84( 3 ); /* cell-set! */
  twobit_movereg( 6, 4 );
  twobit_movereg( 5, 3 );
  twobit_lambda( compiled_start_1_72, 238, 4 );
  twobit_setreg( 3 );
  twobit_reg( 1 );
  twobit_op2_84( 3 ); /* cell-set! */
  twobit_load( 1, 75 );
  twobit_lambda( compiled_start_1_73, 240, 1 );
  twobit_setreg( 3 );
  twobit_stack( 76 );
  twobit_op2_84( 3 ); /* cell-set! */
  twobit_load( 2, 21 );
  twobit_load( 1, 70 );
  twobit_lambda( compiled_start_1_74, 242, 2 );
  twobit_setreg( 3 );
  twobit_stack( 75 );
  twobit_op2_84( 3 ); /* cell-set! */
  twobit_reg( 6 );
  ...
  twobit_stack( 66 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_global( 243 ); /* char-lower-case? */
  twobit_setreg( 1 );
  twobit_stack( 66 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 2 );
  ...
  twobit_setreg( 4 );
  twobit_reg( 4 );
  twobit_setrtn( 1754, compiled_block_1_1754 );
  twobit_invoke( 2 );
  ...
  twobit_stack( 78 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_global( 244 ); /* char-upper-case? */
  twobit_setreg( 1 );
  twobit_stack( 66 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 2 );
  ...
  twobit_stack( 79 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_global( 245 ); /* char-title-case? */
  twobit_setreg( 1 );
  twobit_stack( 66 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 2 );
  ...
  twobit_stack( 80 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_75, 247, 0 );
  twobit_setreg( 1 );
  twobit_stack( 66 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 2 );
  ...
  twobit_stack( 81 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_76, 249, 0 );
  twobit_setreg( 1 );
  twobit_stack( 66 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 2 );
  ...
  twobit_stack( 84 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_77, 252, 0 );
  twobit_setreg( 1 );
  twobit_stack( 66 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 2 );
  ...
  twobit_stack( 85 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_78, 254, 0 );
  twobit_setreg( 1 );
  twobit_stack( 66 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 2 );
  ...
  twobit_stack( 87 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_79, 256, 0 );
  twobit_setreg( 1 );
  twobit_stack( 66 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 2 );
  ...
  twobit_setreg( 4 );
  twobit_reg( 4 );
  twobit_setrtn( 1811, compiled_block_1_1811 );
  twobit_invoke( 2 );
  twobit_label( 1811, compiled_block_1_1811 );
  twobit_load( 0, 0 );
  twobit_setreg( 4 );
  twobit_store( 4, 59 );
  twobit_global( 257 ); /* integer->char */
  twobit_setreg( 1 );
  twobit_const( 258 );
  twobit_setreg( 2 );
  twobit_global( 259 ); /*  map~1pxGHH~1463 */
  ...
  twobit_setreg( 4 );
  twobit_reg( 4 );
  twobit_setrtn( 1815, compiled_block_1_1815 );
  twobit_invoke( 2 );
  ...
  twobit_stack( 89 );
  twobit_op2_84( 4 ); /* cell-set! */
  twobit_lambda( compiled_start_1_80, 261, 0 );
  twobit_setreg( 1 );
  twobit_stack( 66 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 2 );
  ...
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 3 );
  twobit_imm_const( int_to_char(9) ); /* #\tab */
  twobit_setreg( 1 );
  twobit_reg( 3 );
  ...
  twobit_store( 4, 49 );
  twobit_load( 1, 39 );
  twobit_lambda( compiled_start_1_81, 264, 1 );
  twobit_setreg( 3 );
  twobit_stack( 38 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 2 );
  ...
  twobit_store( 4, 36 );
  twobit_load( 1, 35 );
  twobit_lambda( compiled_start_1_82, 266, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 35 );
  twobit_load( 1, 34 );
  twobit_lambda( compiled_start_1_83, 268, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 34 );
  twobit_load( 1, 33 );
  twobit_lambda( compiled_start_1_84, 270, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 33 );
  twobit_stack( 31 );
  twobit_op1_54(); /* cell-ref */
  ...
  twobit_store( 4, 28 );
  twobit_load( 1, 27 );
  twobit_lambda( compiled_start_1_85, 272, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 27 );
  twobit_load( 1, 24 );
  twobit_lambda( compiled_start_1_86, 274, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 24 );
  twobit_load( 1, 23 );
  twobit_lambda( compiled_start_1_87, 276, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 23 );
  twobit_load( 1, 22 );
  twobit_lambda( compiled_start_1_88, 278, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 22 );
  twobit_load( 1, 20 );
  twobit_lambda( compiled_start_1_89, 280, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 20 );
  twobit_load( 1, 19 );
  twobit_lambda( compiled_start_1_90, 282, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 19 );
  twobit_load( 1, 18 );
  twobit_lambda( compiled_start_1_91, 284, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 18 );
  twobit_load( 1, 17 );
  twobit_lambda( compiled_start_1_92, 286, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 17 );
  twobit_load( 1, 16 );
  twobit_lambda( compiled_start_1_93, 288, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 16 );
  twobit_stack( 13 );
  twobit_op1_54(); /* cell-ref */
  ...
  twobit_store( 4, 13 );
  twobit_load( 1, 12 );
  twobit_lambda( compiled_start_1_94, 290, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 12 );
  twobit_stack( 10 );
  twobit_op1_54(); /* cell-ref */
  ...
  twobit_store( 4, 32 );
  twobit_load( 1, 9 );
  twobit_lambda( compiled_start_1_95, 292, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 9 );
  twobit_load( 1, 15 );
  twobit_lambda( compiled_start_1_96, 294, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 15 );
  twobit_stack( 7 );
  twobit_op1_54(); /* cell-ref */
  ...
  twobit_store( 4, 7 );
  twobit_load( 1, 6 );
  twobit_lambda( compiled_start_1_97, 296, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 6 );
  twobit_load( 1, 5 );
  twobit_lambda( compiled_start_1_98, 298, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 5 );
  twobit_stack( 1 );
  twobit_op1_54(); /* cell-ref */
  ...
  twobit_store( 4, 1 );
  twobit_load( 1, 61 );
  twobit_lambda( compiled_start_1_99, 300, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 61 );
  twobit_stack( 63 );
  twobit_op1_54(); /* cell-ref */
  ...
  twobit_store( 4, 63 );
  twobit_load( 1, 64 );
  twobit_lambda( compiled_start_1_100, 302, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 64 );
  twobit_load( 1, 65 );
  twobit_lambda( compiled_start_1_101, 304, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 65 );
  twobit_load( 1, 67 );
  twobit_lambda( compiled_start_1_102, 306, 1 );
  twobit_setreg( 1 );
  twobit_store( 1, 67 );
  twobit_load( 1, 68 );
  twobit_lambda( compiled_start_1_103, 308, 1 );
  twobit_setreg( 1 );
  twobit_stack( 69 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 4 );
...
static RTYPE compiled_start_1_4( CONT_PARAMS ) {
  ...
  twobit_op1_16(); /* cdr */
  twobit_stack( 1 );
  twobit_setglbl( 1 ); /*  char-set?~1pxGHH~14173 */
  twobit_reg( 2 );
  twobit_setglbl( 2 ); /*  char-set-copy~1pxGHH~14202 */
  twobit_reg( 3 );
  twobit_setglbl( 3 ); /*  char-set=~1pxGHH~14203 */
  twobit_reg( 4 );
  twobit_setglbl( 4 ); /*  char-set<=~1pxGHH~14204 */
  twobit_reg( 5 );
  twobit_setglbl( 5 ); /*  char-set-hash~1pxGHH~14205 */
  twobit_reg( 6 );
  twobit_setglbl( 6 ); /*  char-set-contains?~1pxGHH~14206 */
  twobit_reg( 7 );
  twobit_setglbl( 7 ); /*  char-set-size~1pxGHH~14207 */
  twobit_reg( 8 );
  twobit_setglbl( 8 ); /*  char-set-count~1pxGHH~14208 */
  twobit_reg( 9 );
  twobit_setglbl( 9 ); /*  char-set-adjoin~1pxGHH~14209 */
  twobit_reg( 10 );
  twobit_setglbl( 10 ); /*  char-set-adjoin!~1pxGHH~14210 */
  twobit_reg( 11 );
  twobit_setglbl( 11 ); /*  char-set-delete~1pxGHH~14211 */
  twobit_reg( 12 );
  twobit_setglbl( 12 ); /*  char-set-delete!~1pxGHH~14212 */
  twobit_reg( 13 );
  twobit_setglbl( 13 ); /*  char-set-cursor~1pxGHH~14213 */
  twobit_reg( 14 );
  twobit_setglbl( 14 ); /*  end-of-char-set?~1pxGHH~14214 */
  twobit_reg( 15 );
  twobit_setglbl( 15 ); /*  char-set-ref~1pxGHH~14215 */
  twobit_reg( 16 );
  twobit_setglbl( 16 ); /*  char-set-cursor-next~1pxGHH~14216 */
  twobit_reg( 17 );
  twobit_setglbl( 17 ); /*  char-set-for-each~1pxGHH~14218 */
  twobit_reg( 18 );
  twobit_setglbl( 18 ); /*  char-set-map~1pxGHH~14219 */
  twobit_reg( 19 );
  twobit_setglbl( 19 ); /*  char-set-fold~1pxGHH~14220 */
  twobit_reg( 20 );
  twobit_setglbl( 20 ); /*  char-set-every~1pxGHH~14221 */
  twobit_reg( 21 );
  twobit_setglbl( 21 ); /*  char-set-any~1pxGHH~14222 */
  twobit_reg( 22 );
  twobit_setglbl( 22 ); /*  char-set-unfold~1pxGHH~14224 */
  twobit_reg( 23 );
  twobit_setglbl( 23 ); /*  char-set-unfold!~1pxGHH~14225 */
  twobit_reg( 24 );
  twobit_setglbl( 24 ); /*  char-set~1pxGHH~14227 */
  twobit_reg( 25 );
  twobit_setglbl( 25 ); /*  list->char-set~1pxGHH~14228 */
  twobit_reg( 26 );
  twobit_setglbl( 26 ); /*  list->char-set!~1pxGHH~14229 */
  twobit_reg( 27 );
  twobit_setglbl( 27 ); /*  char-set->list~1pxGHH~14230 */
  twobit_reg( 28 );
  twobit_setglbl( 28 ); /*  string->char-set~1pxGHH~14232 */
  twobit_reg( 29 );
  twobit_setglbl( 29 ); /*  string->char-set!~1pxGHH~14233 */
  twobit_reg( 30 );
  twobit_setglbl( 30 ); /*  char-set->string~1pxGHH~14234 */
  twobit_stack( 2 );
  twobit_setglbl( 31 ); /*  ucs-range->char-set~1pxGHH~14236 */
  twobit_stack( 3 );
  twobit_setglbl( 32 ); /*  ucs-range->char-set!~1pxGHH~14237 */
  twobit_stack( 4 );
  twobit_setglbl( 33 ); /*  char-set-filter~1pxGHH~14239 */
  twobit_stack( 5 );
  twobit_setglbl( 34 ); /*  char-set-filter!~1pxGHH~14240 */
  twobit_stack( 6 );
  twobit_setglbl( 35 ); /*  ->char-set~1pxGHH~14241 */
  twobit_stack( 7 );
  twobit_setglbl( 36 ); /*  char-set-complement~1pxGHH~14242 */
  twobit_stack( 8 );
  twobit_setglbl( 37 ); /*  char-set-complement!~1pxGHH~14243 */
  twobit_stack( 9 );
  twobit_setglbl( 38 ); /*  char-set-union!~1pxGHH~14244 */
  twobit_stack( 10 );
  twobit_setglbl( 39 ); /*  char-set-union~1pxGHH~14245 */
  twobit_stack( 11 );
  twobit_setglbl( 40 ); /*  char-set-intersection!~1pxGHH~14246 */
  twobit_stack( 12 );
  twobit_setglbl( 41 ); /*  char-set-intersection~1pxGHH~14247 */
  twobit_stack( 13 );
  twobit_setglbl( 42 ); /*  char-set-difference!~1pxGHH~14248 */
  twobit_stack( 14 );
  twobit_setglbl( 43 ); /*  char-set-difference~1pxGHH~14249 */
  twobit_stack( 15 );
  twobit_setglbl( 44 ); /*  char-set-xor!~1pxGHH~14250 */
  twobit_stack( 16 );
  twobit_setglbl( 45 ); /*  char-set-xor~1pxGHH~14251 */
  twobit_stack( 17 );
  twobit_setglbl( 46 ); /*  char-set-diff+intersection!~1pxGHH~14252 */
  twobit_stack( 18 );
  twobit_setglbl( 47 ); /*  char-set-diff+intersection~1pxGHH~14253 */
  twobit_stack( 19 );
  twobit_setglbl( 48 ); /*  char-set:empty~1pxGHH~14254 */
  twobit_stack( 20 );
  twobit_setglbl( 49 ); /*  char-set:full~1pxGHH~14255 */
  twobit_stack( 21 );
  twobit_setglbl( 50 ); /*  char-set:lower-case~1pxGHH~14256 */
  twobit_stack( 22 );
  twobit_setglbl( 51 ); /*  char-set:upper-case~1pxGHH~14257 */
  twobit_stack( 23 );
  twobit_setglbl( 52 ); /*  char-set:title-case~1pxGHH~14258 */
  twobit_stack( 24 );
  twobit_setglbl( 53 ); /*  char-set:letter~1pxGHH~14259 */
  twobit_stack( 25 );
  twobit_setglbl( 54 ); /*  char-set:digit~1pxGHH~14260 */
  twobit_stack( 26 );
  twobit_setglbl( 55 ); /*  char-set:hex-digit~1pxGHH~14261 */
  twobit_stack( 27 );
  twobit_setglbl( 56 ); /*  char-set:letter+digit~1pxGHH~14262 */
  twobit_stack( 28 );
  twobit_setglbl( 57 ); /*  char-set:punctuation~1pxGHH~14263 */
  twobit_stack( 29 );
  twobit_setglbl( 58 ); /*  char-set:symbol~1pxGHH~14264 */
  twobit_stack( 30 );
  twobit_setglbl( 59 ); /*  char-set:graphic~1pxGHH~14265 */
  twobit_stack( 31 );
  twobit_setglbl( 60 ); /*  char-set:whitespace~1pxGHH~14266 */
  twobit_stack( 32 );
  twobit_setglbl( 61 ); /*  char-set:printing~1pxGHH~14267 */
  twobit_stack( 33 );
  twobit_setglbl( 62 ); /*  char-set:blank~1pxGHH~14268 */
  twobit_stack( 34 );
  twobit_setglbl( 63 ); /*  char-set:iso-control~1pxGHH~14269 */
  twobit_stack( 35 );
  twobit_setglbl( 64 ); /*  char-set:ascii~1pxGHH~14270 */
...
static RTYPE compiled_start_1_8( CONT_PARAMS ) {
  ...
  twobit_load( 0, 0 );
  twobit_imm_const_setreg( fixnum(8), 3 ); /* 8 */
  twobit_op2_64( 3, 209, compiled_temp_1_209 ); /* / */
  twobit_pop( 0 );
  twobit_return();
  twobit_epilogue();
}
...
static RTYPE compiled_start_1_9( CONT_PARAMS ) {
  twobit_prologue(); 
  twobit_argseq( 0 );
  twobit_imm_const( fixnum(1114112) ); /* 1114112 */
  twobit_return();
  twobit_epilogue();
}
...
static RTYPE compiled_start_1_10( CONT_PARAMS ) {
  ...
  twobit_load( 0, 0 );
  twobit_imm_const_setreg( fixnum(8), 3 ); /* 8 */
  twobit_op2_64( 3, 208, compiled_temp_1_208 ); /* / */
  twobit_pop( 0 );
  twobit_return();
  twobit_epilogue();
}
...
static RTYPE compiled_start_1_11( CONT_PARAMS ) {
  ...
  twobit_load( 0, 0 );
  twobit_setreg( 4 );
  twobit_reg_op1_check_651(reg(4),1025,compiled_block_1_1025); /* internal:check-fixnum? with (4 0 0) */
  twobit_stack( 1 );
  ...
  twobit_load( 3, 2 );
  twobit_check( 4, 3, 0, 1028, compiled_block_1_1028 );
  twobit_reg( 4 );
  twobit_op2imm_455( fixnum(0) ); /* >=:fix:fix */
  twobit_load( 1, 2 );
  twobit_check( 4, 1, 0, 1029, compiled_block_1_1029 );
  twobit_stack( 2 );
  ...
  twobit_imm_const( fixnum(0) ); /* 0 */
  twobit_setreg( 2 );
  twobit_global( 1 ); /* bytevector-copy */
  twobit_pop( 2 );
  twobit_invoke( 3 );
  ...
  twobit_load( 1, 2 );
  twobit_check( 4, 1, 0, 1029, compiled_block_1_1029 );
  twobit_reg_op2imm_check_660(reg(4),fixnum(0),1029,compiled_block_1_1029); /* internal:check->=:fix:fix/imm with (4 1 0) */
  twobit_stack( 2 );
  twobit_op2_96( 4 ); /* bytevector-like-ref */
  twobit_setreg( 3 );
  twobit_imm_const( fixnum(0) ); /* 0 */
...
static RTYPE compiled_start_1_12( CONT_PARAMS ) {
  ...
  twobit_store( 2, 1 );
  twobit_reg( 1 );
  twobit_op2imm_130( fixnum(7), 201, compiled_temp_1_201 ); /* + */
  twobit_setreg( 4 );
  twobit_reg( 4 );
  twobit_op1_branchf_614( 1044, compiled_block_1_1044 ); /* internal:branchf-fixnum? */
  twobit_reg( 4 );
  twobit_op2imm_455( fixnum(0) ); /* >=:fix:fix */
  ...
  twobit_setreg( 3 );
  twobit_reg( 4 );
  twobit_op2_65( 3, 202, compiled_temp_1_202 ); /* quotient */
  ...
  twobit_setreg( 4 );
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_op2_63( 4, 203, compiled_temp_1_203 ); /* * */
  twobit_setreg( 3 );
  twobit_store( 3, 3 );
  twobit_reg( 4 );
  twobit_op1_46(); /* make-bytevector */
  twobit_setreg( 4 );
  twobit_store( 4, 2 );
  twobit_stack( 1 );
  twobit_op2imm_branchf_640( fixnum(0), 1049, compiled_block_1_1049 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(0) ); /* 0 */
  twobit_skip( 1048, compiled_block_1_1048 );
  twobit_label( 1049, compiled_block_1_1049 );
  twobit_stack( 1 );
  twobit_op2imm_branchf_640( fixnum(1), 1051, compiled_block_1_1051 ); /* internal:branchf-eq?/imm */
  ...
  twobit_setreg( 4 );
  twobit_stack( 2 );
  twobit_op2_45( 4 ); /* bytevector-fill! */
  twobit_load( 4, 3 );
  twobit_stack( 4 );
  twobit_op2_branchf_621( 4, 204, compiled_temp_1_204, 1054, compiled_block_1_1054 ); /* internal:branchf->= */
  ...
  twobit_reg( 3 );
  twobit_op2_branchf_621( 1, 206, compiled_temp_1_206, 1058, compiled_block_1_1058 ); /* internal:branchf->= */
  twobit_op1_3(); /* unspecified */
  twobit_return();
  ...
  twobit_load( 0, 0 );
  twobit_stack( 2 );
  twobit_op2imm_130( fixnum(1), 207, compiled_temp_1_207 ); /* + */
  twobit_setreg( 3 );
  twobit_load( 1, 3 );
  twobit_load( 2, 1 );
  twobit_pop( 3 );
...
static RTYPE compiled_start_1_13( CONT_PARAMS ) {
  ...
  twobit_reg( 1 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 1, 0, 0, 1061, compiled_block_1_1061 );
  twobit_reg( 1 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 4 );
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_op2_63( 4, 200, compiled_temp_1_200 ); /* * */
  twobit_return();
...
static RTYPE compiled_start_1_14( CONT_PARAMS ) {
  ...
  twobit_store( 2, 1 );
  twobit_reg( 2 );
  twobit_op1_branchf_614( 1063, compiled_block_1_1063 ); /* internal:branchf-fixnum? */
  twobit_reg( 2 );
  twobit_op2imm_455( fixnum(0) ); /* >=:fix:fix */
  ...
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_65( 4, 199, compiled_temp_1_199 ); /* quotient */
  ...
  twobit_setreg( 3 );
  twobit_stack( 1 );
  twobit_op2_71( 3 ); /* fxlogand */
  twobit_setreg( 3 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(0), 1068, compiled_block_1_1068 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(1) ); /* 1 */
  twobit_skip( 1067, compiled_block_1_1067 );
  twobit_label( 1068, compiled_block_1_1068 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(1), 1070, compiled_block_1_1070 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(2) ); /* 2 */
  twobit_skip( 1067, compiled_block_1_1067 );
  twobit_label( 1070, compiled_block_1_1070 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(2), 1072, compiled_block_1_1072 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(4) ); /* 4 */
  twobit_skip( 1067, compiled_block_1_1067 );
  twobit_label( 1072, compiled_block_1_1072 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(3), 1074, compiled_block_1_1074 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_skip( 1067, compiled_block_1_1067 );
  twobit_label( 1074, compiled_block_1_1074 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(4), 1076, compiled_block_1_1076 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(16) ); /* 16 */
  twobit_skip( 1067, compiled_block_1_1067 );
  twobit_label( 1076, compiled_block_1_1076 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(5), 1078, compiled_block_1_1078 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(32) ); /* 32 */
  twobit_skip( 1067, compiled_block_1_1067 );
  twobit_label( 1078, compiled_block_1_1078 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(6), 1080, compiled_block_1_1080 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(64) ); /* 64 */
  twobit_skip( 1067, compiled_block_1_1067 );
  twobit_label( 1080, compiled_block_1_1080 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(7), 1082, compiled_block_1_1082 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(128) ); /* 128 */
  twobit_skip( 1067, compiled_block_1_1067 );
  ...
  twobit_load( 3, 2 );
  twobit_check( 4, 3, 0, 1083, compiled_block_1_1083 );
  twobit_stack( 2 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 4, 3, 0, 1083, compiled_block_1_1083 );
  twobit_stack( 2 );
  ...
  twobit_load( 3, 2 );
  twobit_check( 4, 3, 0, 1083, compiled_block_1_1083 );
  twobit_reg_op2imm_check_660(reg(4),fixnum(0),1083,compiled_block_1_1083); /* internal:check->=:fix:fix/imm with (4 3 0) */
  twobit_stack( 2 );
  twobit_op2_96( 4 ); /* bytevector-like-ref */
  twobit_op2_71( 2 ); /* fxlogand */
  twobit_setreg( 4 );
  twobit_reg_op1_check_651(reg(4),1084,compiled_block_1_1084); /* internal:check-fixnum? with (4 0 0) */
  twobit_imm_const( fixnum(0) ); /* 0 */
  twobit_op2_406( 4 ); /* =:fix:fix */
...
static RTYPE compiled_start_1_15( CONT_PARAMS ) {
  ...
  twobit_store( 3, 2 );
  twobit_reg( 2 );
  twobit_op1_branchf_614( 1088, compiled_block_1_1088 ); /* internal:branchf-fixnum? */
  twobit_reg( 2 );
  twobit_op2imm_455( fixnum(0) ); /* >=:fix:fix */
  twobit_skip( 1087, compiled_block_1_1087 );
  ...
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_65( 4, 197, compiled_temp_1_197 ); /* quotient */
  twobit_skip( 1089, compiled_block_1_1089 );
  ...
  twobit_setreg( 3 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(0), 1093, compiled_block_1_1093 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(1) ); /* 1 */
  twobit_skip( 1092, compiled_block_1_1092 );
  twobit_label( 1093, compiled_block_1_1093 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(1), 1095, compiled_block_1_1095 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(2) ); /* 2 */
  twobit_skip( 1092, compiled_block_1_1092 );
  twobit_label( 1095, compiled_block_1_1095 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(2), 1097, compiled_block_1_1097 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(4) ); /* 4 */
  twobit_skip( 1092, compiled_block_1_1092 );
  twobit_label( 1097, compiled_block_1_1097 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(3), 1099, compiled_block_1_1099 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_skip( 1092, compiled_block_1_1092 );
  twobit_label( 1099, compiled_block_1_1099 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(4), 1101, compiled_block_1_1101 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(16) ); /* 16 */
  twobit_skip( 1092, compiled_block_1_1092 );
  twobit_label( 1101, compiled_block_1_1101 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(5), 1103, compiled_block_1_1103 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(32) ); /* 32 */
  twobit_skip( 1092, compiled_block_1_1092 );
  twobit_label( 1103, compiled_block_1_1103 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(6), 1105, compiled_block_1_1105 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(64) ); /* 64 */
  twobit_skip( 1092, compiled_block_1_1092 );
  twobit_label( 1105, compiled_block_1_1105 );
  twobit_reg( 3 );
  twobit_op2imm_branchf_640( fixnum(7), 1107, compiled_block_1_1107 ); /* internal:branchf-eq?/imm */
  twobit_imm_const( fixnum(128) ); /* 128 */
  twobit_skip( 1092, compiled_block_1_1092 );
  ...
  twobit_setreg( 2 );
  twobit_stack( 2 );
  twobit_op2_63( 2, 198, compiled_temp_1_198 ); /* * */
  twobit_setreg( 3 );
  twobit_reg( 2 );
  twobit_op1_33(); /* fxlognot */
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op1_23(); /* fixnum? */
  twobit_load( 1, 3 );
  twobit_check( 4, 1, 0, 1108, compiled_block_1_1108 );
  twobit_stack( 3 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 4, 1, 0, 1108, compiled_block_1_1108 );
  twobit_stack( 3 );
  ...
  twobit_load( 1, 3 );
  twobit_check( 4, 1, 0, 1108, compiled_block_1_1108 );
  twobit_reg_op2imm_check_660(reg(4),fixnum(0),1108,compiled_block_1_1108); /* internal:check->=:fix:fix/imm with (4 1 0) */
  twobit_stack( 3 );
  twobit_op2_96( 4 ); /* bytevector-like-ref */
  twobit_op2_71( 2 ); /* fxlogand */
  twobit_setreg( 1 );
  twobit_reg( 3 );
  twobit_op2_72( 1 ); /* fxlogior */
  twobit_setreg( 3 );
  twobit_reg( 3 );
  twobit_op1_23(); /* fixnum? */
  twobit_load( 2, 3 );
  twobit_check( 3, 4, 2, 1109, compiled_block_1_1109 );
  twobit_reg_op2imm_check_658(reg(3),fixnum(256),1109,compiled_block_1_1109); /* internal:check-<:fix:fix/imm with (3 4 2) */
  twobit_reg_op2imm_check_660(reg(3),fixnum(-128),1109,compiled_block_1_1109); /* internal:check->=:fix:fix/imm with (3 4 2) */
  twobit_stack( 3 );
  twobit_op3_97( 4, 3 ); /* bytevector-like-set! */
  twobit_pop( 3 );
  twobit_return();
  twobit_label( 1108, compiled_block_1_1108 );
  twobit_trap( 1, 4, 0, 70 );
  twobit_label( 1109, compiled_block_1_1109 );
  twobit_trap( 2, 4, 3, 71 );
  twobit_epilogue();
}
...
static RTYPE compiled_start_1_18( CONT_PARAMS ) {
  ...
  twobit_load( 0, 0 );
  twobit_branchf( 1132, compiled_block_1_1132 );
  twobit_load( 1, 1 );
  twobit_lexical( 0, 1 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 4 );
  ...
  twobit_load( 1, 2 );
  twobit_pop( 2 );
  twobit_branch( 1127, compiled_block_1_1127 );
  twobit_epilogue();
}
...
static RTYPE compiled_start_1_19( CONT_PARAMS ) {
  ...
  twobit_op1_23(); /* fixnum? */
  twobit_load( 2, 1 );
  twobit_check( 2, 0, 0, 1137, compiled_block_1_1137 );
  twobit_reg_op1_check_651(reg(4),1138,compiled_block_1_1138); /* internal:check-fixnum? with (4 0 0) */
  twobit_stack( 1 );
  twobit_op2_407( 4 ); /* <:fix:fix */
  twobit_branchf( 1140, compiled_block_1_1140 );
  twobit_lexical( 0, 1 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 4 );
  twobit_load( 1, 2 );
  ...
  twobit_load( 0, 0 );
  twobit_setreg( 4 );
  twobit_reg_op1_check_651(reg(4),1142,compiled_block_1_1142); /* internal:check-fixnum? with (4 0 0) */
  twobit_imm_const( fixnum(0) ); /* 0 */
  twobit_op2_406( 4 ); /* =:fix:fix */
  twobit_pop( 2 );
  twobit_return();
  ...
  twobit_op1_43(); /* bytevector? */
  twobit_load( 3, 2 );
  twobit_check( 3, 0, 0, 1143, compiled_block_1_1143 );
  twobit_stack( 2 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 4 );
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_op2_63( 4, 196, compiled_temp_1_196 ); /* * */
  twobit_setreg( 4 );
  twobit_reg_op1_check_651(reg(4),1138,compiled_block_1_1138); /* internal:check-fixnum? with (4 0 0) */
  twobit_stack( 1 );
  twobit_op2_407( 4 ); /* <:fix:fix */
...
static RTYPE compiled_start_1_20( CONT_PARAMS ) {
  ...
  twobit_op1_23(); /* fixnum? */
  twobit_load( 2, 1 );
  twobit_check( 2, 0, 0, 1148, compiled_block_1_1148 );
  twobit_reg_op1_check_651(reg(4),1149,compiled_block_1_1149); /* internal:check-fixnum? with (4 0 0) */
  twobit_stack( 1 );
  twobit_op2_407( 4 ); /* <:fix:fix */
  twobit_branchf( 1151, compiled_block_1_1151 );
  twobit_lexical( 0, 1 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 4 );
  twobit_load( 1, 2 );
  ...
  twobit_load( 0, 0 );
  twobit_setreg( 4 );
  twobit_reg_op1_check_651(reg(4),1153,compiled_block_1_1153); /* internal:check-fixnum? with (4 0 0) */
  twobit_imm_const( fixnum(1) ); /* 1 */
  twobit_op2_406( 4 ); /* =:fix:fix */
  twobit_pop( 2 );
  twobit_return();
  ...
  twobit_op1_43(); /* bytevector? */
  twobit_load( 3, 2 );
  twobit_check( 3, 0, 0, 1154, compiled_block_1_1154 );
  twobit_stack( 2 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 4 );
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_op2_63( 4, 195, compiled_temp_1_195 ); /* * */
  twobit_setreg( 4 );
  twobit_reg_op1_check_651(reg(4),1149,compiled_block_1_1149); /* internal:check-fixnum? with (4 0 0) */
  twobit_stack( 1 );
  twobit_op2_407( 4 ); /* <:fix:fix */
...
static RTYPE compiled_start_1_24( CONT_PARAMS ) {
  ...
  twobit_setreg( 4 );
  twobit_reg( 4 );
  twobit_branchf( 1164, compiled_block_1_1164 );
  twobit_reg( 4 );
  twobit_return();
  ...
  twobit_load( 1, 2 );
  twobit_pop( 2 );
  twobit_branch( 1161, compiled_block_1_1161 );
  twobit_label( 1160, compiled_block_1_1160 );
  twobit_reg( 4 );
  twobit_op2_406( 3 ); /* =:fix:fix */
  twobit_branchf( 1169, compiled_block_1_1169 );
  twobit_imm_const( TRUE_CONST ); /* #t */
  twobit_return();
  ...
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 31 );
  twobit_reg_op2_check_655(reg(4),reg(31),1170,compiled_block_1_1170); /* internal:check-<:fix:fix with (4 2 0) */
  twobit_reg( 2 );
  twobit_op2_96( 4 ); /* bytevector-like-ref */
  twobit_setreg( 31 );
  twobit_reg( 1 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 30 );
  twobit_reg_op2_check_655(reg(4),reg(30),1171,compiled_block_1_1171); /* internal:check-<:fix:fix with (4 1 0) */
  twobit_reg( 1 );
  twobit_op2_96( 4 ); /* bytevector-like-ref */
  twobit_op2_406( 31 ); /* =:fix:fix */
  twobit_branchf( 1173, compiled_block_1_1173 );
  twobit_reg( 4 );
  twobit_op2imm_521( fixnum(1), 194, compiled_temp_1_194 ); /* +:fix:fix */
  twobit_setreg( 4 );
  twobit_branch( 1160, compiled_block_1_1160 );
  ...
  twobit_setreg( 31 );
  twobit_reg( 31 );
  twobit_branchf( 1176, compiled_block_1_1176 );
  twobit_reg( 31 );
  twobit_return();
  twobit_label( 1176, compiled_block_1_1176 );
  twobit_reg( 4 );
  twobit_check( 3, 0, 0, 1177, compiled_block_1_1177 );
  twobit_reg( 3 );
  twobit_op1_404(); /* car:pair */
  twobit_setreg( 4 );
  twobit_reg( 1 );
  ...
  twobit_setreg( 31 );
  twobit_reg( 31 );
  twobit_branchf( 1179, compiled_block_1_1179 );
  twobit_reg( 31 );
  twobit_return();
  ...
  twobit_op1_43(); /* bytevector? */
  twobit_load( 2, 1 );
  twobit_check( 2, 0, 0, 1181, compiled_block_1_1181 );
  twobit_stack( 1 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 3 );
  twobit_reg( 4 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 4, 0, 0, 1182, compiled_block_1_1182 );
  twobit_reg( 4 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 2 );
  twobit_reg( 3 );
  twobit_op2_406( 2 ); /* =:fix:fix */
  ...
  twobit_load( 0, 0 );
  twobit_skip( 1183, compiled_block_1_1183 );
...
static RTYPE compiled_start_1_25( CONT_PARAMS ) {
  ...
  twobit_save( 1 );
  twobit_store( 0, 0 );
  twobit_reg_op1_check_652(reg(1),1194,compiled_block_1_1194); /* internal:check-pair? with (1 0 0) */
  twobit_reg( 1 );
  twobit_op1_404(); /* car:pair */
  twobit_setreg( 4 );
  twobit_reg( 1 );
  ...
  twobit_load( 2, 1 );
  twobit_pop( 1 );
  twobit_branch( 1190, compiled_block_1_1190 );
  twobit_label( 1189, compiled_block_1_1189 );
  twobit_reg( 4 );
  twobit_op2_406( 3 ); /* =:fix:fix */
  twobit_branchf( 1198, compiled_block_1_1198 );
  twobit_imm_const( TRUE_CONST ); /* #t */
  twobit_return();
  ...
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 31 );
  twobit_reg_op2_check_655(reg(4),reg(31),1199,compiled_block_1_1199); /* internal:check-<:fix:fix with (4 2 0) */
  twobit_reg( 2 );
  twobit_op2_96( 4 ); /* bytevector-like-ref */
  twobit_setreg( 31 );
  twobit_reg( 1 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 30 );
  twobit_reg_op2_check_655(reg(4),reg(30),1200,compiled_block_1_1200); /* internal:check-<:fix:fix with (4 1 0) */
  twobit_reg( 1 );
  twobit_op2_96( 4 ); /* bytevector-like-ref */
  twobit_op2_72( 31 ); /* fxlogior */
  twobit_op2_406( 31 ); /* =:fix:fix */
  twobit_branchf( 1202, compiled_block_1_1202 );
  twobit_reg( 4 );
  twobit_op2imm_521( fixnum(1), 193, compiled_temp_1_193 ); /* +:fix:fix */
  twobit_setreg( 4 );
  twobit_branch( 1189, compiled_block_1_1189 );
  ...
  twobit_setreg( 3 );
  twobit_reg( 3 );
  twobit_branchf( 1205, compiled_block_1_1205 );
  twobit_reg( 3 );
  twobit_return();
  ...
  twobit_store( 2, 1 );
  twobit_reg( 4 );
  twobit_check( 2, 0, 0, 1206, compiled_block_1_1206 );
  twobit_reg( 2 );
  twobit_op1_404(); /* car:pair */
  twobit_setreg( 1 );
  twobit_lexical( 0, 2 );
  ...
  twobit_store( 3, 1 );
  twobit_stack( 2 );
  twobit_op2_branchf_624( 4, 1209, compiled_block_1_1209 ); /* internal:branchf-eq? */
  twobit_movereg( 3, 2 );
  twobit_movereg( 4, 1 );
  twobit_pop( 3 );
  twobit_branch( 1190, compiled_block_1_1190 );
  ...
  twobit_op1_43(); /* bytevector? */
  twobit_load( 1, 2 );
  twobit_check( 1, 0, 0, 1211, compiled_block_1_1211 );
  twobit_stack( 2 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 4, 0, 0, 1212, compiled_block_1_1212 );
  twobit_reg( 4 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 1 );
  twobit_reg( 2 );
  twobit_op2_408( 1 ); /* <=:fix:fix */
  ...
  twobit_load( 0, 0 );
  twobit_branchf( 1217, compiled_block_1_1217 );
  twobit_load( 1, 3 );
  twobit_load( 2, 1 );
  twobit_pop( 3 );
  twobit_branch( 1190, compiled_block_1_1190 );
...
static RTYPE compiled_start_1_26( CONT_PARAMS ) {
  ...
  twobit_imm_const( fixnum(0) ); /* 0 */
  twobit_op2_67( 3, 183, compiled_temp_1_183 ); /* <= */
  ...
  twobit_branchf( 1229, compiled_block_1_1229 );
  twobit_reg( 4 );
  twobit_check( 2, 0, 0, 1230, compiled_block_1_1230 );
  twobit_reg( 2 );
  twobit_op1_404(); /* car:pair */
  twobit_skip( 1228, compiled_block_1_1228 );
  twobit_label( 1229, compiled_block_1_1229 );
  twobit_imm_const( fixnum(4194304) ); /* 4194304 */
  twobit_label( 1228, compiled_block_1_1228 );
  twobit_setreg( 3 );
  twobit_reg( 3 );
  twobit_op1_branchf_612( 184, compiled_temp_1_184, 1232, compiled_block_1_1232 ); /* internal:branchf-zero? */
  twobit_imm_const( fixnum(4194304) ); /* 4194304 */
  ...
  twobit_reg( 4 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 4, 0, 0, 1234, compiled_block_1_1234 );
  twobit_reg( 4 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 3 );
  twobit_store( 3, 2 );
  ...
  twobit_op2_branchf_621( 2, 185, compiled_temp_1_185, 1236, compiled_block_1_1236 ); /* internal:branchf->= */
  twobit_imm_const( fixnum(65535) ); /* 65535 */
  twobit_skip( 1235, compiled_block_1_1235 );
  twobit_label( 1236, compiled_block_1_1236 );
  twobit_movereg( 2, 1 );
  twobit_imm_const( fixnum(131072) ); /* 131072 */
  twobit_setreg( 2 );
  ...
  twobit_reg( 5 );
  twobit_op2_407( 3 ); /* <:fix:fix */
  twobit_branchf( 1240, compiled_block_1_1240 );
  twobit_save( 5 );
  twobit_store( 0, 0 );
  twobit_store( 1, 2 );
  twobit_store( 2, 3 );
  ...
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 30 );
  twobit_reg_op2_check_655(reg(5),reg(30),1241,compiled_block_1_1241); /* internal:check-<:fix:fix with (5 2 0) */
  twobit_reg( 2 );
  twobit_op2_96( 5 ); /* bytevector-like-ref */
  twobit_setreg( 30 );
  twobit_reg( 5 );
  twobit_op2_63( 30, 186, compiled_temp_1_186 ); /* * */
  twobit_setreg( 30 );
  twobit_imm_const( fixnum(37) ); /* 37 */
  twobit_op2_63( 6, 187, compiled_temp_1_187 ); /* * */
  twobit_op2_61( 30, 188, compiled_temp_1_188 ); /* + */
  twobit_setreg( 2 );
  twobit_global( 1 ); /* bitwise-and */
  ...
  twobit_reg( 6 );
  twobit_op1_branchf_614( 1245, compiled_block_1_1245 ); /* internal:branchf-fixnum? */
  twobit_reg( 1 );
  twobit_op1_branchf_614( 1247, compiled_block_1_1247 ); /* internal:branchf-fixnum? */
  twobit_reg( 6 );
  twobit_op2imm_455( fixnum(0) ); /* >=:fix:fix */
  ...
  twobit_reg( 6 );
  twobit_op2_103( 1, 189, compiled_temp_1_189 ); /* remainder */
  twobit_return();
  ...
  twobit_reg( 2 );
  twobit_op2_branchf_621( 1, 190, compiled_temp_1_190, 1252, compiled_block_1_1252 ); /* internal:branchf->= */
  twobit_reg( 2 );
  twobit_op2imm_131( fixnum(1), 191, compiled_temp_1_191 ); /* - */
  twobit_return();
  twobit_label( 1252, compiled_block_1_1252 );
  twobit_reg( 2 );
  twobit_op2_61( 2, 192, compiled_temp_1_192 ); /* + */
  twobit_setreg( 2 );
  twobit_branch( 1220, compiled_block_1_1220 );
  twobit_label( 1230, compiled_block_1_1230 );
  twobit_trap( 2, 0, 0, 0 );
  twobit_label( 1241, compiled_block_1_1241 );
  twobit_trap( 2, 5, 0, 70 );
...
static RTYPE compiled_start_1_28( CONT_PARAMS ) {
  ...
  twobit_reg( 4 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 4, 0, 0, 1259, compiled_block_1_1259 );
  twobit_reg( 4 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 2 );
  twobit_movereg( 4, 1 );
  ...
  twobit_reg( 3 );
  twobit_op2_406( 2 ); /* =:fix:fix */
  twobit_branchf( 1262, compiled_block_1_1262 );
  twobit_reg( 4 );
  twobit_return();
  ...
  twobit_store( 4, 1 );
  twobit_reg( 3 );
  twobit_op2imm_521( fixnum(1), 181, compiled_temp_1_181 ); /* +:fix:fix */
  twobit_setreg( 31 );
  twobit_store( 31, 4 );
  twobit_reg_op1_check_651(reg(31),1263,compiled_block_1_1263); /* internal:check-fixnum? with (0 3 0) */
  twobit_reg( 1 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 30 );
  twobit_reg_op2_check_655(reg(3),reg(30),1264,compiled_block_1_1264); /* internal:check-<:fix:fix with (3 1 0) */
  twobit_reg( 1 );
  twobit_op2_96( 3 ); /* bytevector-like-ref */
  twobit_setreg( 1 );
  twobit_global( 1 ); /* fxbit-count */
  ...
  twobit_op1_23(); /* fixnum? */
  twobit_load( 1, 1 );
  twobit_check( 4, 1, 0, 1266, compiled_block_1_1266 );
  twobit_stack( 1 );
  twobit_op2_501( 4, 182, compiled_temp_1_182 ); /* +:fix:fix */
  twobit_setreg( 3 );
  twobit_reg( 3 );
  twobit_op1_23(); /* fixnum? */
  twobit_load( 2, 1 );
  twobit_check( 4, 2, 0, 1267, compiled_block_1_1267 );
  twobit_movereg( 3, 4 );
  twobit_load( 1, 2 );
  twobit_load( 2, 3 );
  twobit_load( 3, 4 );
  twobit_pop( 4 );
  twobit_branch( 1256, compiled_block_1_1256 );
  twobit_label( 1263, compiled_block_1_1263 );
  twobit_imm_const( fixnum(1) ); /* 1 */
  twobit_setreg( 1 );
  twobit_trap( 3, 1, 0, 140 );
  twobit_label( 1267, compiled_block_1_1267 );
  twobit_trap( 2, 4, 0, 140 );
  twobit_label( 1259, compiled_block_1_1259 );
  twobit_trap( 4, 0, 0, 72 );
  twobit_label( 1266, compiled_block_1_1266 );
  twobit_trap( 1, 4, 0, 140 );
  twobit_label( 1264, compiled_block_1_1264 );
  twobit_trap( 1, 3, 0, 70 );
  twobit_epilogue();
}
...
static RTYPE compiled_start_1_29( CONT_PARAMS ) {
  ...
  twobit_reg( 4 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 4, 0, 0, 1272, compiled_block_1_1272 );
  twobit_reg( 4 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 3 );
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_op2_63( 3, 177, compiled_temp_1_177 ); /* * */
  twobit_setreg( 3 );
  twobit_load( 1, 1 );
  twobit_movereg( 4, 2 );
  twobit_imm_const( fixnum(0) ); /* 0 */
  ...
  twobit_reg_op1_check_651(reg(3),1274,compiled_block_1_1274); /* internal:check-fixnum? with (3 0 0) */
  twobit_reg( 4 );
  twobit_op2_406( 3 ); /* =:fix:fix */
  twobit_branchf( 1276, compiled_block_1_1276 );
  twobit_reg( 5 );
  twobit_return();
  ...
  twobit_load( 0, 0 );
  twobit_branchf( 1279, compiled_block_1_1279 );
  twobit_stack( 2 );
  twobit_setreg( 4 );
  twobit_stack( 3 );
  ...
  twobit_load( 0, 0 );
  twobit_skip( 1278, compiled_block_1_1278 );
  twobit_label( 1279, compiled_block_1_1279 );
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_label( 1278, compiled_block_1_1278 );
  twobit_branchf( 1282, compiled_block_1_1282 );
  twobit_stack( 3 );
  twobit_op2imm_521( fixnum(1), 178, compiled_temp_1_178 ); /* +:fix:fix */
  twobit_setreg( 4 );
  twobit_reg( 4 );
  twobit_op1_23(); /* fixnum? */
  twobit_load( 2, 3 );
  twobit_check( 0, 2, 0, 1283, compiled_block_1_1283 );
  twobit_stack( 4 );
  twobit_op2imm_521( fixnum(1), 179, compiled_temp_1_179 ); /* +:fix:fix */
  twobit_setreg( 3 );
  twobit_reg( 3 );
  twobit_op1_23(); /* fixnum? */
  twobit_load( 1, 4 );
  twobit_check( 0, 1, 0, 1284, compiled_block_1_1284 );
  twobit_movereg( 3, 5 );
  twobit_load( 1, 2 );
  twobit_load( 2, 1 );
  twobit_load( 3, 5 );
  twobit_pop( 5 );
  twobit_branch( 1269, compiled_block_1_1269 );
  twobit_label( 1282, compiled_block_1_1282 );
  twobit_stack( 3 );
  twobit_op2imm_521( fixnum(1), 180, compiled_temp_1_180 ); /* +:fix:fix */
  twobit_setreg( 4 );
  twobit_reg( 4 );
  twobit_op1_23(); /* fixnum? */
  twobit_load( 2, 3 );
...
static RTYPE compiled_start_1_35( CONT_PARAMS ) {
  ...
  twobit_argseq( 1 );
  twobit_reg( 1 );
  twobit_op2imm_132( fixnum(0), 176, compiled_temp_1_176 ); /* < */
  twobit_return();
  twobit_epilogue();
}
...
static RTYPE compiled_start_1_38( CONT_PARAMS ) {
  ...
  twobit_reg( 4 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 4, 0, 0, 1301, compiled_block_1_1301 );
  twobit_reg( 4 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 3 );
  twobit_store( 3, 5 );
  twobit_stack( 1 );
  twobit_op2imm_branchf_635( fixnum(0), 166, compiled_temp_1_166, 1303, compiled_block_1_1303 ); /* internal:branchf-</imm */
  twobit_movereg( 3, 2 );
  twobit_movereg( 4, 1 );
  twobit_imm_const( fixnum(0) ); /* 0 */
  twobit_setreg( 3 );
  twobit_pop( 5 );
  twobit_branch( 1298, compiled_block_1_1298 );
  ...
  twobit_setreg( 1 );
  twobit_stack( 1 );
  twobit_op2_65( 1, 167, compiled_temp_1_167 ); /* quotient */
  twobit_skip( 1307, compiled_block_1_1307 );
  ...
  twobit_store( 4, 3 );
  twobit_stack( 2 );
  twobit_branchf( 1311, compiled_block_1_1311 );
  twobit_stack( 1 );
  twobit_op2imm_455( fixnum(0) ); /* >=:fix:fix */
  twobit_skip( 1310, compiled_block_1_1310 );
  twobit_label( 1311, compiled_block_1_1311 );
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_label( 1310, compiled_block_1_1310 );
  twobit_branchf( 1313, compiled_block_1_1313 );
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_setreg( 3 );
  twobit_stack( 1 );
  twobit_op2_103( 3, 168, compiled_temp_1_168 ); /* remainder */
  twobit_skip( 1312, compiled_block_1_1312 );
  ...
  twobit_setreg( 4 );
  twobit_stack( 1 );
  twobit_op2imm_130( fixnum(1), 169, compiled_temp_1_169 ); /* + */
  twobit_setreg( 3 );
  twobit_store( 3, 1 );
  twobit_stack( 3 );
  twobit_op1_23(); /* fixnum? */
  twobit_load( 2, 4 );
  twobit_load( 1, 3 );
  twobit_check( 1, 2, 0, 1316, compiled_block_1_1316 );
  twobit_load( 2, 5 );
  twobit_stack( 3 );
  twobit_op2_407( 2 ); /* <:fix:fix */
  twobit_load( 1, 4 );
  twobit_load( 2, 3 );
  twobit_check( 2, 1, 0, 1317, compiled_block_1_1317 );
  twobit_stack( 3 );
  twobit_op2imm_455( fixnum(0) ); /* >=:fix:fix */
  twobit_load( 2, 4 );
  twobit_load( 1, 3 );
  ...
  twobit_load( 2, 3 );
  twobit_stack( 4 );
  twobit_op2_96( 2 ); /* bytevector-like-ref */
  twobit_setreg( 3 );
  twobit_reg( 4 );
  twobit_op2_61( 4, 170, compiled_temp_1_170 ); /* + */
  twobit_setreg( 4 );
  twobit_movereg( 4, 5 );
  twobit_movereg( 2, 4 );
  twobit_load( 1, 4 );
  ...
  twobit_reg_op1_check_651(reg(5),1319,compiled_block_1_1319); /* internal:check-fixnum? with (5 0 0) */
  twobit_reg( 5 );
  twobit_op2imm_451( fixnum(256) ); /* =:fix:fix */
  twobit_branchf( 1321, compiled_block_1_1321 );
  twobit_reg( 4 );
  twobit_op2imm_521( fixnum(1), 171, compiled_temp_1_171 ); /* +:fix:fix */
  twobit_setreg( 4 );
  twobit_movereg( 4, 3 );
  twobit_branch( 1298, compiled_block_1_1298 );
  twobit_label( 1321, compiled_block_1_1321 );
  twobit_reg( 3 );
  twobit_op2_71( 5 ); /* fxlogand */
  twobit_setreg( 31 );
  twobit_imm_const( fixnum(0) ); /* 0 */
  twobit_op2_406( 31 ); /* =:fix:fix */
  twobit_branchf( 1324, compiled_block_1_1324 );
  twobit_reg( 5 );
  twobit_op2_501( 5, 172, compiled_temp_1_172 ); /* +:fix:fix */
  twobit_setreg( 31 );
  twobit_reg_op1_check_651(reg(31),1325,compiled_block_1_1325); /* internal:check-fixnum? with (5 5 0) */
  twobit_reg_op1_check_651(reg(6),1326,compiled_block_1_1326); /* internal:check-fixnum? with (0 6 0) */
  twobit_reg( 6 );
  twobit_op2imm_521( fixnum(1), 173, compiled_temp_1_173 ); /* +:fix:fix */
  twobit_setreg( 30 );
  twobit_reg_op1_check_651(reg(30),1326,compiled_block_1_1326); /* internal:check-fixnum? with (0 6 0) */
  twobit_movereg( 31, 5 );
  twobit_movereg( 30, 6 );
  twobit_branch( 1297, compiled_block_1_1297 );
  ...
  twobit_reg( 3 );
  twobit_op2_406( 2 ); /* =:fix:fix */
  twobit_branchf( 1329, compiled_block_1_1329 );
  twobit_imm_const( fixnum(-1) ); /* -1 */
  twobit_return();
  ...
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 4 );
  twobit_reg_op2_check_655(reg(3),reg(4),1330,compiled_block_1_1330); /* internal:check-<:fix:fix with (3 1 0) */
  twobit_reg( 1 );
  twobit_op2_96( 3 ); /* bytevector-like-ref */
  twobit_setreg( 4 );
  twobit_imm_const( fixnum(0) ); /* 0 */
  ...
  twobit_movereg( 3, 4 );
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_op2_63( 3, 174, compiled_temp_1_174 ); /* * */
  twobit_setreg( 3 );
  twobit_movereg( 3, 6 );
  twobit_load( 3, 1 );
  twobit_imm_const( fixnum(1) ); /* 1 */
...
static RTYPE compiled_start_1_39( CONT_PARAMS ) {
  ...
  twobit_load( 2, 2 );
  twobit_pop( 3 );
  twobit_branch( 1335, compiled_block_1_1335 );
  twobit_epilogue();
}
...
static RTYPE compiled_start_1_40( CONT_PARAMS ) {
  ...
  twobit_load( 0, 0 );
  twobit_branchf( 1352, compiled_block_1_1352 );
  twobit_load( 1, 1 );
  twobit_lexical( 0, 4 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 4 );
...
static RTYPE compiled_start_1_41( CONT_PARAMS ) {
  ...
  twobit_load( 0, 0 );
  twobit_branchf( 1364, compiled_block_1_1364 );
  twobit_stack( 1 );
  twobit_pop( 5 );
  twobit_return();
  ...
  twobit_load( 2, 3 );
  twobit_pop( 5 );
  twobit_branch( 1358, compiled_block_1_1358 );
  twobit_epilogue();
}
...
static RTYPE compiled_start_1_42( CONT_PARAMS ) {
  ...
  twobit_load( 0, 0 );
  twobit_branchf( 1379, compiled_block_1_1379 );
  twobit_load( 2, 1 );
  twobit_load( 1, 2 );
  twobit_lexical( 0, 2 );
  twobit_op1_54(); /* cell-ref */
  ...
  twobit_load( 2, 2 );
  twobit_pop( 3 );
  twobit_branch( 1369, compiled_block_1_1369 );
...
static RTYPE compiled_start_1_43( CONT_PARAMS ) {
  ...
  twobit_load( 0, 0 );
  twobit_branchf( 1388, compiled_block_1_1388 );
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_pop( 3 );
  twobit_return();
  ...
  twobit_setreg( 4 );
  twobit_reg( 4 );
  twobit_branchf( 1392, compiled_block_1_1392 );
  twobit_reg( 4 );
  twobit_pop( 3 );
  twobit_return();
  ...
  twobit_load( 2, 2 );
  twobit_pop( 3 );
  twobit_branch( 1382, compiled_block_1_1382 );
  twobit_epilogue();
}
...
static RTYPE compiled_start_1_44( CONT_PARAMS ) {
  ...
  twobit_load( 0, 0 );
  twobit_branchf( 1401, compiled_block_1_1401 );
  twobit_load( 1, 1 );
  twobit_lexical( 0, 2 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 4 );
  ...
  twobit_load( 3, 3 );
  twobit_pop( 6 );
  twobit_branch( 1395, compiled_block_1_1395 );
  twobit_epilogue();
}
...
static RTYPE compiled_start_1_47( CONT_PARAMS ) {
  ...
  twobit_reg( 4 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 4, 0, 0, 1411, compiled_block_1_1411 );
  twobit_reg( 4 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 3 );
  twobit_store( 3, 4 );
  ...
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_op2_63( 3, 160, compiled_temp_1_160 ); /* * */
  twobit_setreg( 2 );
  twobit_stack( 2 );
  twobit_op1_11(); /* pair? */
  twobit_load( 1, 2 );
  twobit_check( 1, 0, 0, 1414, compiled_block_1_1414 );
  twobit_stack( 2 );
  twobit_op1_404(); /* car:pair */
  twobit_op1_37(); /* char->integer */
  twobit_setreg( 1 );
  twobit_reg_op1_check_651(reg(1),1415,compiled_block_1_1415); /* internal:check-fixnum? with (1 0 0) */
  twobit_reg_op1_check_651(reg(2),1416,compiled_block_1_1416); /* internal:check-fixnum? with (2 0 0) */
  twobit_reg( 1 );
  twobit_op2_407( 2 ); /* <:fix:fix */
  twobit_branchf( 1418, compiled_block_1_1418 );
  twobit_movereg( 4, 1 );
  twobit_global( 3 ); /* bytevector-copy */
  ...
  twobit_store( 4, 1 );
  twobit_movereg( 4, 1 );
  twobit_lambda( compiled_start_1_161, 5, 1 );
  twobit_setreg( 1 );
  twobit_load( 2, 2 );
  twobit_global( 6 ); /*  for-each~1pxGHH~1464 */
  ...
  twobit_imm_const( fixnum(7) ); /* 7 */
  twobit_op2_501( 1, 162, compiled_temp_1_162 ); /* +:fix:fix */
  twobit_setreg( 2 );
  twobit_reg( 2 );
  twobit_op1_branchf_614( 1424, compiled_block_1_1424 ); /* internal:branchf-fixnum? */
  twobit_reg( 2 );
  twobit_op2imm_455( fixnum(0) ); /* >=:fix:fix */
  twobit_skip( 1423, compiled_block_1_1423 );
  twobit_label( 1424, compiled_block_1_1424 );
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_label( 1423, compiled_block_1_1423 );
  twobit_branchf( 1426, compiled_block_1_1426 );
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_setreg( 1 );
  twobit_reg( 2 );
  twobit_op2_65( 1, 163, compiled_temp_1_163 ); /* quotient */
  ...
  twobit_setreg( 4 );
  twobit_imm_const( fixnum(1) ); /* 1 */
  twobit_op2_61( 4, 164, compiled_temp_1_164 ); /* + */
  twobit_op1_46(); /* make-bytevector */
  twobit_setreg( 4 );
  twobit_store( 4, 1 );
  twobit_imm_const( fixnum(0) ); /* 0 */
  twobit_setreg( 3 );
  twobit_reg( 4 );
  twobit_op2_45( 3 ); /* bytevector-fill! */
  twobit_movereg( 4, 1 );
  twobit_imm_const( fixnum(0) ); /* 0 */
  twobit_setreg( 2 );
  twobit_load( 3, 3 );
  ...
  twobit_setreg( 4 );
  twobit_load( 5, 4 );
  twobit_global( 9 ); /*  bytevector-copy!~1pxGHH~4479 */
  twobit_setrtn( 1428, compiled_block_1_1428 );
  twobit_invoke( 5 );
  twobit_label( 1428, compiled_block_1_1428 );
  twobit_load( 0, 0 );
  twobit_load( 1, 1 );
  twobit_lambda( compiled_start_1_165, 11, 1 );
  twobit_setreg( 1 );
  twobit_load( 2, 2 );
  twobit_global( 6 ); /*  for-each~1pxGHH~1464 */
...
static RTYPE compiled_start_1_51( CONT_PARAMS ) {
  ...
  twobit_load( 0, 0 );
  twobit_branchf( 1442, compiled_block_1_1442 );
  twobit_load( 1, 1 );
  ...
  twobit_load( 1, 2 );
  twobit_pop( 4 );
  twobit_branch( 1436, compiled_block_1_1436 );
  twobit_epilogue();
}
...
static RTYPE compiled_start_1_56( CONT_PARAMS ) {
  ...
  twobit_argseq( 5 );
  twobit_imm_const( fixnum(1114112) ); /* 1114112 */
  twobit_op2_branchf_622( 1, 115, compiled_temp_1_115, 1459, compiled_block_1_1459 ); /* internal:branchf-<= */
  twobit_lexical( 0, 6 );
  twobit_op1_54(); /* cell-ref */
  twobit_return();
  twobit_label( 1459, compiled_block_1_1459 );
  twobit_imm_const( fixnum(1114112) ); /* 1114112 */
  twobit_op2_branchf_619( 2, 116, compiled_temp_1_116, 1461, compiled_block_1_1461 ); /* internal:branchf-< */
  twobit_lexical( 0, 5 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 2 );
  twobit_movereg( 2, 6 );
  ...
  twobit_reg( 1 );
  twobit_op2imm_133( fixnum(57343), 117, compiled_temp_1_117 ); /* <= */
  twobit_setreg( 31 );
  twobit_imm_const( fixnum(55296) ); /* 55296 */
  twobit_op2_branchf_622( 1, 118, compiled_temp_1_118, 1464, compiled_block_1_1464 ); /* internal:branchf-<= */
  twobit_reg( 31 );
  twobit_skip( 1463, compiled_block_1_1463 );
  twobit_label( 1464, compiled_block_1_1464 );
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_label( 1463, compiled_block_1_1463 );
  twobit_branchf( 1466, compiled_block_1_1466 );
  twobit_reg( 2 );
  twobit_op2imm_branchf_637( fixnum(57344), 119, compiled_temp_1_119, 1468, compiled_block_1_1468 ); /* internal:branchf->=/imm */
  twobit_reg( 2 );
  twobit_skip( 1467, compiled_block_1_1467 );
  twobit_label( 1468, compiled_block_1_1468 );
  twobit_imm_const( fixnum(57344) ); /* 57344 */
  twobit_label( 1467, compiled_block_1_1467 );
  twobit_setreg( 1 );
  twobit_reg( 2 );
  twobit_op2_68( 2, 120, compiled_temp_1_120 ); /* = */
  twobit_op1_9(); /* not */
  twobit_branchf( 1470, compiled_block_1_1470 );
  twobit_imm_const( TRUE_CONST ); /* #t */
  ...
  twobit_branchf( 1476, compiled_block_1_1476 );
  twobit_reg( 1 );
  twobit_op1_26(); /* inexact? */
  ...
  twobit_setreg( 31 );
  twobit_reg( 1 );
  twobit_op2_61( 31, 121, compiled_temp_1_121 ); /* + */
  twobit_skip( 1471, compiled_block_1_1471 );
  ...
  twobit_reg( 2 );
  twobit_op2imm_133( fixnum(57343), 122, compiled_temp_1_122 ); /* <= */
  twobit_setreg( 31 );
  twobit_imm_const( fixnum(55296) ); /* 55296 */
  twobit_op2_branchf_622( 2, 123, compiled_temp_1_123, 1481, compiled_block_1_1481 ); /* internal:branchf-<= */
  twobit_reg( 31 );
  twobit_skip( 1480, compiled_block_1_1480 );
  twobit_label( 1481, compiled_block_1_1481 );
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_label( 1480, compiled_block_1_1480 );
  twobit_branchf( 1483, compiled_block_1_1483 );
  twobit_reg( 1 );
  twobit_op2imm_branchf_638( fixnum(55295), 124, compiled_temp_1_124, 1485, compiled_block_1_1485 ); /* internal:branchf-<=/imm */
  twobit_reg( 1 );
  twobit_skip( 1484, compiled_block_1_1484 );
  twobit_label( 1485, compiled_block_1_1485 );
  twobit_imm_const( fixnum(55295) ); /* 55295 */
  twobit_label( 1484, compiled_block_1_1484 );
  twobit_setreg( 2 );
  twobit_reg( 1 );
  twobit_op2_68( 1, 125, compiled_temp_1_125 ); /* = */
  twobit_op1_9(); /* not */
  twobit_branchf( 1487, compiled_block_1_1487 );
  twobit_imm_const( TRUE_CONST ); /* #t */
  twobit_skip( 1486, compiled_block_1_1486 );
  twobit_label( 1487, compiled_block_1_1487 );
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_label( 1486, compiled_block_1_1486 );
  twobit_branchf( 1489, compiled_block_1_1489 );
  twobit_const( 1 );
  twobit_skip( 1488, compiled_block_1_1488 );
  ...
  twobit_setreg( 31 );
  twobit_reg( 2 );
  twobit_op2_61( 31, 126, compiled_temp_1_126 ); /* + */
  twobit_skip( 1488, compiled_block_1_1488 );
  ...
  twobit_load( 0, 0 );
  twobit_load( 3, 1 );
  twobit_op2_branchf_619( 3, 127, compiled_temp_1_127, 1499, compiled_block_1_1499 ); /* internal:branchf-< */
  twobit_stack( 2 );
  ...
  twobit_setreg( 4 );
  twobit_stack( 4 );
  twobit_op2_branchf_622( 4, 128, compiled_temp_1_128, 1508, compiled_block_1_1508 ); /* internal:branchf-<= */
  twobit_stack( 4 );
  twobit_skip( 1507, compiled_block_1_1507 );
  ...
  twobit_load( 2, 4 );
  twobit_reg( 2 );
  twobit_op2_68( 2, 129, compiled_temp_1_129 ); /* = */
  twobit_op1_9(); /* not */
  twobit_branchf( 1510, compiled_block_1_1510 );
  twobit_imm_const( TRUE_CONST ); /* #t */
  twobit_skip( 1509, compiled_block_1_1509 );
  twobit_label( 1510, compiled_block_1_1510 );
  twobit_reg( 4 );
  twobit_op2_branchf_623( 4, 130, compiled_temp_1_130, 1512, compiled_block_1_1512 ); /* internal:branchf-= */
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_skip( 1509, compiled_block_1_1509 );
  ...
  twobit_const( 1 );
  twobit_skip( 1513, compiled_block_1_1513 );
  twobit_label( 1514, compiled_block_1_1514 );
  twobit_reg( 2 );
  twobit_op1_26(); /* inexact? */
  twobit_branchf( 1516, compiled_block_1_1516 );
  twobit_imm_const( TRUE_CONST ); /* #t */
  ...
  twobit_branchf( 1518, compiled_block_1_1518 );
  twobit_reg( 3 );
  twobit_op1_26(); /* inexact? */
  ...
  twobit_setreg( 1 );
  twobit_reg( 3 );
  twobit_op2_61( 1, 131, compiled_temp_1_131 ); /* + */
  twobit_skip( 1513, compiled_block_1_1513 );
  ...
  twobit_load( 4, 1 );
  twobit_stack( 4 );
  twobit_op2_branchf_623( 4, 132, compiled_temp_1_132, 1524, compiled_block_1_1524 ); /* internal:branchf-= */
  twobit_stack( 6 );
  twobit_pop( 6 );
  twobit_return();
  ...
  twobit_reg( 4 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 4, 0, 0, 1526, compiled_block_1_1526 );
  twobit_reg( 4 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 3 );
  twobit_store( 3, 6 );
  twobit_stack( 1 );
  twobit_op2imm_130( fixnum(7), 133, compiled_temp_1_133 ); /* + */
  twobit_setreg( 2 );
  twobit_reg( 2 );
  twobit_op1_branchf_614( 1528, compiled_block_1_1528 ); /* internal:branchf-fixnum? */
  twobit_reg( 2 );
  twobit_op2imm_455( fixnum(0) ); /* >=:fix:fix */
  twobit_skip( 1527, compiled_block_1_1527 );
  twobit_label( 1528, compiled_block_1_1528 );
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_label( 1527, compiled_block_1_1527 );
  twobit_branchf( 1530, compiled_block_1_1530 );
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_setreg( 1 );
  twobit_reg( 2 );
  twobit_op2_65( 1, 134, compiled_temp_1_134 ); /* quotient */
  twobit_skip( 1529, compiled_block_1_1529 );
  ...
  twobit_setreg( 4 );
  twobit_stack( 6 );
  twobit_op2_branchf_621( 4, 135, compiled_temp_1_135, 1533, compiled_block_1_1533 ); /* internal:branchf->= */
  twobit_stack( 6 );
  twobit_skip( 1532, compiled_block_1_1532 );
  ...
  twobit_reg( 4 );
  twobit_op2_branchf_623( 4, 136, compiled_temp_1_136, 1537, compiled_block_1_1537 ); /* internal:branchf-= */
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_skip( 1534, compiled_block_1_1534 );
  twobit_label( 1537, compiled_block_1_1537 );
  twobit_imm_const( TRUE_CONST ); /* #t */
  twobit_label( 1534, compiled_block_1_1534 );
  twobit_branchf( 1539, compiled_block_1_1539 );
  twobit_const( 1 );
  twobit_skip( 1538, compiled_block_1_1538 );
  twobit_label( 1539, compiled_block_1_1539 );
  twobit_reg( 4 );
  twobit_op1_26(); /* inexact? */
  twobit_branchf( 1541, compiled_block_1_1541 );
  twobit_reg( 3 );
  twobit_op1_26(); /* inexact? */
  twobit_branchf( 1543, compiled_block_1_1543 );
  twobit_reg( 3 );
  twobit_skip( 1538, compiled_block_1_1538 );
  ...
  twobit_setreg( 1 );
  twobit_reg( 3 );
  twobit_op2_61( 1, 137, compiled_temp_1_137 ); /* + */
  twobit_skip( 1538, compiled_block_1_1538 );
  ...
  twobit_setreg( 1 );
  twobit_reg( 1 );
  twobit_op2_branchf_623( 2, 138, compiled_temp_1_138, 1545, compiled_block_1_1545 ); /* internal:branchf-= */
  twobit_load( 1, 3 );
  twobit_global( 11 ); /* bytevector-copy */
  twobit_setrtn( 1546, compiled_block_1_1546 );
  twobit_invoke( 1 );
  twobit_label( 1546, compiled_block_1_1546 );
  twobit_load( 0, 0 );
  twobit_skip( 1544, compiled_block_1_1544 );
  ...
  twobit_setreg( 2 );
  twobit_load( 3, 3 );
  twobit_global( 12 ); /*  bytevector-copy!~1pxGHH~4479 */
  ...
  twobit_store( 4, 2 );
  twobit_stack( 4 );
  twobit_op1_branchf_614( 1549, compiled_block_1_1549 ); /* internal:branchf-fixnum? */
  twobit_stack( 4 );
  twobit_op2imm_455( fixnum(0) ); /* >=:fix:fix */
  twobit_skip( 1548, compiled_block_1_1548 );
  twobit_label( 1549, compiled_block_1_1549 );
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_label( 1548, compiled_block_1_1548 );
  twobit_branchf( 1551, compiled_block_1_1551 );
  twobit_imm_const( fixnum(8) ); /* 8 */
  twobit_setreg( 3 );
  twobit_stack( 4 );
  twobit_op2_65( 3, 139, compiled_temp_1_139 ); /* quotient */
  ...
  twobit_store( 4, 5 );
  twobit_stack( 1 );
  twobit_op1_branchf_614( 1554, compiled_block_1_1554 ); /* internal:branchf-fixnum? */
  twobit_stack( 1 );
  twobit_op2imm_455( fixnum(0) ); /* >=:fix:fix */
  ...
  twobit_setreg( 3 );
  twobit_stack( 1 );
  twobit_op2_65( 3, 140, compiled_temp_1_140 ); /* quotient */
  ...
  twobit_load( 0, 0 );
  twobit_stack( 1 );
  twobit_op2imm_131( fixnum(8), 141, compiled_temp_1_141 ); /* - */
  twobit_setreg( 4 );
  twobit_stack( 4 );
  twobit_op2_branchf_621( 4, 142, compiled_temp_1_142, 1560, compiled_block_1_1560 ); /* internal:branchf->= */
  twobit_stack( 4 );
  twobit_skip( 1559, compiled_block_1_1559 );
  ...
  twobit_load( 2, 4 );
  twobit_reg( 2 );
  twobit_op2_68( 2, 143, compiled_temp_1_143 ); /* = */
  twobit_op1_9(); /* not */
  ...
  twobit_reg( 4 );
  twobit_op2_branchf_623( 4, 144, compiled_temp_1_144, 1564, compiled_block_1_1564 ); /* internal:branchf-= */
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_skip( 1561, compiled_block_1_1561 );
  twobit_label( 1564, compiled_block_1_1564 );
  twobit_imm_const( TRUE_CONST ); /* #t */
  twobit_label( 1561, compiled_block_1_1561 );
  twobit_branchf( 1566, compiled_block_1_1566 );
  twobit_const( 1 );
  ...
  twobit_imm_const( TRUE_CONST ); /* #t */
  twobit_skip( 1567, compiled_block_1_1567 );
  twobit_label( 1568, compiled_block_1_1568 );
  twobit_reg( 4 );
  twobit_op1_26(); /* inexact? */
  twobit_label( 1567, compiled_block_1_1567 );
  twobit_branchf( 1570, compiled_block_1_1570 );
  twobit_reg( 3 );
  twobit_op1_26(); /* inexact? */
  twobit_branchf( 1572, compiled_block_1_1572 );
  twobit_reg( 3 );
  twobit_skip( 1565, compiled_block_1_1565 );
  ...
  twobit_setreg( 1 );
  twobit_reg( 3 );
  twobit_op2_61( 1, 145, compiled_temp_1_145 ); /* + */
  twobit_skip( 1565, compiled_block_1_1565 );
  ...
  twobit_branch( 1455, compiled_block_1_1455 );
  twobit_label( 1573, compiled_block_1_1573 );
  twobit_load( 0, 0 );
  twobit_load( 2, 3 );
  twobit_stack( 5 );
  twobit_op2imm_130( fixnum(1), 146, compiled_temp_1_146 ); /* + */
  twobit_setreg( 3 );
  twobit_load( 1, 2 );
  twobit_setrtn( 1574, compiled_block_1_1574 );
  twobit_branch( 1454, compiled_block_1_1454 );
  ...
  twobit_reg_op1_check_651(reg(3),1576,compiled_block_1_1576); /* internal:check-fixnum? with (3 0 0) */
  twobit_reg_op1_check_651(reg(2),1577,compiled_block_1_1577); /* internal:check-fixnum? with (2 0 0) */
  twobit_reg( 3 );
  twobit_op2_409( 2 ); /* >=:fix:fix */
  ...
  twobit_setreg( 4 );
  twobit_reg( 3 );
  twobit_op2_67( 4, 147, compiled_temp_1_147 ); /* <= */
  twobit_setreg( 31 );
  twobit_lexical( 0, 8 );
  twobit_op2_branchf_622( 3, 148, compiled_temp_1_148, 1581, compiled_block_1_1581 ); /* internal:branchf-<= */
  twobit_reg( 31 );
  twobit_skip( 1580, compiled_block_1_1580 );
  twobit_label( 1581, compiled_block_1_1581 );
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_label( 1580, compiled_block_1_1580 );
  twobit_branchf( 1583, compiled_block_1_1583 );
  twobit_imm_const( fixnum(1) ); /* 1 */
  twobit_op2_61( 4, 149, compiled_temp_1_149 ); /* + */
  twobit_setreg( 3 );
  twobit_branch( 1454, compiled_block_1_1454 );
  twobit_label( 1583, compiled_block_1_1583 );
  twobit_reg( 1 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 0, 3, 1, 1585, compiled_block_1_1585 );
  twobit_reg( 1 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 4 );
  twobit_reg_op2_check_661(reg(3),reg(4),1585,compiled_block_1_1585); /* internal:check-range with (0 3 1) */
  twobit_imm_const( fixnum(255) ); /* 255 */
  twobit_setreg( 4 );
  twobit_reg( 1 );
  twobit_op3_97( 3, 4 ); /* bytevector-like-set! */
  twobit_reg( 3 );
  twobit_op2imm_520( fixnum(1) ); /* +:idx:idx */
  twobit_setreg( 3 );
  twobit_branch( 1454, compiled_block_1_1454 );
  ...
  twobit_reg( 3 );
  twobit_op2_branchf_621( 1, 150, compiled_temp_1_150, 1588, compiled_block_1_1588 ); /* internal:branchf->= */
  twobit_imm_const( TRUE_CONST ); /* #t */
  twobit_return();
  twobit_label( 1588, compiled_block_1_1588 );
  twobit_reg( 3 );
  twobit_op2imm_133( fixnum(57343), 151, compiled_temp_1_151 ); /* <= */
  twobit_setreg( 4 );
  twobit_imm_const( fixnum(55296) ); /* 55296 */
  twobit_op2_branchf_622( 3, 152, compiled_temp_1_152, 1590, compiled_block_1_1590 ); /* internal:branchf-<= */
  twobit_reg( 4 );
  twobit_skip( 1589, compiled_block_1_1589 );
  ...
  twobit_load( 0, 0 );
  twobit_stack( 2 );
  twobit_op2imm_130( fixnum(1), 153, compiled_temp_1_153 ); /* + */
  twobit_setreg( 3 );
  twobit_load( 1, 3 );
  twobit_load( 2, 1 );
  twobit_pop( 3 );
  ...
  twobit_reg( 4 );
  twobit_op2_branchf_621( 2, 154, compiled_temp_1_154, 1596, compiled_block_1_1596 ); /* internal:branchf->= */
  twobit_imm_const( TRUE_CONST ); /* #t */
  twobit_return();
  twobit_label( 1596, compiled_block_1_1596 );
  twobit_reg( 1 );
  twobit_op2imm_130( fixnum(8), 155, compiled_temp_1_155 ); /* + */
  twobit_setreg( 31 );
  twobit_reg( 4 );
  twobit_op2_branchf_621( 31, 156, compiled_temp_1_156, 1598, compiled_block_1_1598 ); /* internal:branchf->= */
  twobit_imm_const( TRUE_CONST ); /* #t */
  twobit_return();
  twobit_label( 1598, compiled_block_1_1598 );
  twobit_reg( 4 );
  twobit_op2imm_133( fixnum(57343), 157, compiled_temp_1_157 ); /* <= */
  twobit_setreg( 31 );
  twobit_imm_const( fixnum(55296) ); /* 55296 */
  twobit_op2_branchf_622( 4, 158, compiled_temp_1_158, 1600, compiled_block_1_1600 ); /* internal:branchf-<= */
  twobit_reg( 31 );
  twobit_skip( 1599, compiled_block_1_1599 );
  twobit_label( 1600, compiled_block_1_1600 );
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_label( 1599, compiled_block_1_1599 );
  twobit_branchf( 1602, compiled_block_1_1602 );
  twobit_imm_const( TRUE_CONST ); /* #t */
  twobit_return();
...
static RTYPE compiled_start_1_57( CONT_PARAMS ) {
  ...
  twobit_op1_405(); /* cdr:pair */
  twobit_setreg( 1 );
  twobit_skip( 1605, compiled_block_1_1605 );
  ...
  twobit_setreg( 4 );
  twobit_stack( 1 );
  twobit_op1_branchf_610( 1609, compiled_block_1_1609 ); /* internal:branchf-null? */
  twobit_imm_const( FALSE_CONST ); /* #f */
  twobit_skip( 1608, compiled_block_1_1608 );
  twobit_label( 1609, compiled_block_1_1609 );
  twobit_stack( 2 );
  twobit_load( 2, 1 );
  twobit_check( 2, 0, 0, 1610, compiled_block_1_1610 );
  twobit_stack( 1 );
  twobit_op1_404(); /* car:pair */
...
static RTYPE compiled_start_1_59( CONT_PARAMS ) {
  ...
  twobit_op1_43(); /* bytevector? */
  twobit_load( 2, 3 );
  twobit_check( 2, 0, 0, 1615, compiled_block_1_1615 );
  twobit_stack( 3 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 3 );
  twobit_reg( 4 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 4, 0, 0, 1616, compiled_block_1_1616 );
  twobit_reg( 4 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 4 );
  twobit_reg( 3 );
  twobit_op2_409( 4 ); /* >=:fix:fix */
  twobit_setreg( 2 );
  twobit_reg( 2 );
  twobit_branchf( 1618, compiled_block_1_1618 );
  twobit_reg( 3 );
  ...
  twobit_op2_406( 3 ); /* =:fix:fix */
  twobit_op1_9(); /* not */
  twobit_branchf( 1620, compiled_block_1_1620 );
  twobit_imm_const( TRUE_CONST ); /* #t */
  ...
  twobit_load( 1, 3 );
  twobit_global( 2 ); /* bytevector-copy */
  ...
  twobit_setreg( 2 );
  twobit_load( 3, 3 );
  twobit_global( 3 ); /*  bytevector-copy!~1pxGHH~4479 */
  ...
  twobit_load( 2, 4 );
  twobit_movereg( 4, 1 );
  twobit_lambda( compiled_start_1_114, 5, 2 );
  twobit_setreg( 1 );
  twobit_lexical( 0, 3 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 3 );
...
static RTYPE compiled_start_1_62( CONT_PARAMS ) {
  ...
  twobit_setreg( 4 );
  twobit_reg( 4 );
  twobit_setrtn( 1639, compiled_block_1_1639 );
  twobit_invoke( 1 );
  twobit_label( 1639, compiled_block_1_1639 );
  twobit_load( 0, 0 );
  twobit_branchf( 1641, compiled_block_1_1641 );
  twobit_stack( 1 );
  twobit_pop( 1 );
  twobit_return();
  ...
  twobit_branchf( 1643, compiled_block_1_1643 );
  twobit_lexical( 0, 3 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 4 );
  twobit_load( 1, 1 );
  ...
  twobit_stack( 1 );
  twobit_op1_branchf_615( 1646, compiled_block_1_1646 ); /* internal:branchf-char? */
  twobit_lexical( 0, 2 );
  twobit_op1_54(); /* cell-ref */
  twobit_setreg( 4 );
  twobit_load( 1, 1 );
...
static RTYPE compiled_start_1_66( CONT_PARAMS ) {
  ...
  twobit_argsge( 0 );
  twobit_reg( 1 );
  twobit_op1_branchf_610( 1655, compiled_block_1_1655 ); /* internal:branchf-null? */
  twobit_lexical( 0, 4 );
  twobit_op1_54(); /* cell-ref */
  twobit_return();
  twobit_label( 1655, compiled_block_1_1655 );
  twobit_reg_op1_check_652(reg(1),1656,compiled_block_1_1656); /* internal:check-pair? with (1 0 0) */
  twobit_reg( 1 );
  twobit_op1_405(); /* cdr:pair */
  twobit_op1_branchf_610( 1658, compiled_block_1_1658 ); /* internal:branchf-null? */
  twobit_reg( 1 );
  twobit_op1_404(); /* car:pair */
  twobit_return();
  ...
  twobit_store( 4, 1 );
  twobit_movereg( 4, 2 );
  twobit_global( 4 ); /* bytevector-length */
  twobit_setreg( 1 );
  twobit_global( 3 ); /*  map~1pxGHH~1463 */
  ...
  twobit_op2_45( 3 ); /* bytevector-fill! */
  twobit_movereg( 4, 1 );
  twobit_lambda( compiled_start_1_113, 8, 1 );
  twobit_setreg( 1 );
  twobit_load( 2, 1 );
  twobit_global( 9 ); /*  for-each~1pxGHH~1464 */
...
static RTYPE compiled_start_1_113( CONT_PARAMS ) {
  ...
  twobit_reg( 1 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 1, 0, 0, 1665, compiled_block_1_1665 );
  twobit_reg( 1 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 2 );
  twobit_imm_const( fixnum(0) ); /* 0 */
  ...
  twobit_reg( 3 );
  twobit_op2_406( 2 ); /* =:fix:fix */
  twobit_branchf( 1668, compiled_block_1_1668 );
  twobit_op1_3(); /* unspecified */
  twobit_return();
  ...
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 4 );
  twobit_reg_op2_check_655(reg(3),reg(4),1669,compiled_block_1_1669); /* internal:check-<:fix:fix with (3 1 0) */
  twobit_reg( 1 );
  twobit_op2_96( 3 ); /* bytevector-like-ref */
  twobit_setreg( 4 );
  twobit_lexical( 0, 1 );
  ...
  twobit_setreg( 30 );
  twobit_reg( 31 );
  twobit_check( 3, 30, 0, 1670, compiled_block_1_1670 );
  twobit_lexical( 0, 1 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 31 );
  twobit_reg( 3 );
  ...
  twobit_lexical( 0, 1 );
  twobit_op2_96( 3 ); /* bytevector-like-ref */
  twobit_op2_72( 4 ); /* fxlogior */
  twobit_setreg( 31 );
  twobit_reg( 31 );
  twobit_op2imm_452( fixnum(256) ); /* <:fix:fix */
  twobit_setreg( 4 );
  twobit_lexical( 0, 1 );
  twobit_setreg( 30 );
  twobit_reg( 4 );
  twobit_check( 31, 3, 30, 1671, compiled_block_1_1671 );
  twobit_reg( 31 );
  twobit_op2imm_455( fixnum(-128) ); /* >=:fix:fix */
  twobit_setreg( 4 );
  twobit_lexical( 0, 1 );
  twobit_setreg( 30 );
  twobit_reg( 4 );
  twobit_check( 31, 3, 30, 1671, compiled_block_1_1671 );
  twobit_lexical( 0, 1 );
  twobit_op3_97( 3, 31 ); /* bytevector-like-set! */
  twobit_reg( 3 );
  twobit_op2imm_520( fixnum(1) ); /* +:idx:idx */
  twobit_setreg( 3 );
  twobit_branch( 1663, compiled_block_1_1663 );
  twobit_label( 1670, compiled_block_1_1670 );
  twobit_trap( 30, 3, 0, 70 );
  twobit_label( 1665, compiled_block_1_1665 );
  twobit_trap( 1, 0, 0, 72 );
  twobit_label( 1671, compiled_block_1_1671 );
  twobit_trap( 30, 3, 31, 71 );
...
static RTYPE compiled_start_1_68( CONT_PARAMS ) {
  ...
  twobit_argsge( 0 );
  twobit_reg( 1 );
  twobit_op1_branchf_610( 1677, compiled_block_1_1677 ); /* internal:branchf-null? */
  twobit_lexical( 0, 4 );
  twobit_op1_54(); /* cell-ref */
  twobit_return();
  twobit_label( 1677, compiled_block_1_1677 );
  twobit_reg_op1_check_652(reg(1),1678,compiled_block_1_1678); /* internal:check-pair? with (1 0 0) */
  twobit_reg( 1 );
  twobit_op1_405(); /* cdr:pair */
  twobit_op1_branchf_610( 1680, compiled_block_1_1680 ); /* internal:branchf-null? */
  twobit_reg( 1 );
  twobit_op1_404(); /* car:pair */
  twobit_return();
  ...
  twobit_store( 0, 0 );
  twobit_movereg( 1, 2 );
  twobit_lambda( compiled_start_1_109, 2, 0 );
  twobit_setreg( 1 );
  twobit_global( 3 ); /*  map~1pxGHH~1463 */
  ...
  twobit_setreg( 2 );
  twobit_reg( 3 );
  twobit_op2_45( 2 ); /* bytevector-fill! */
  twobit_movereg( 4, 2 );
  twobit_movereg( 3, 1 );
  twobit_lambda( compiled_start_1_110, 8, 2 );
  twobit_setreg( 1 );
  twobit_load( 2, 1 );
  twobit_global( 9 ); /*  for-each~1pxGHH~1464 */
...
static RTYPE compiled_start_1_110( CONT_PARAMS ) {
  ...
  twobit_reg( 1 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 1, 0, 0, 1687, compiled_block_1_1687 );
  twobit_imm_const( fixnum(0) ); /* 0 */
  twobit_setreg( 2 );
  ...
  twobit_setreg( 4 );
  twobit_reg( 2 );
  twobit_op2_branchf_623( 4, 111, compiled_temp_1_111, 1690, compiled_block_1_1690 ); /* internal:branchf-= */
  twobit_op1_3(); /* unspecified */
  twobit_return();
  ...
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 4 );
  twobit_reg_op2_check_655(reg(2),reg(4),1691,compiled_block_1_1691); /* internal:check-<:fix:fix with (2 1 0) */
  twobit_reg( 1 );
  twobit_op2_96( 2 ); /* bytevector-like-ref */
  twobit_setreg( 4 );
  twobit_lexical( 0, 1 );
  ...
  twobit_setreg( 31 );
  twobit_reg( 3 );
  twobit_check( 2, 31, 0, 1692, compiled_block_1_1692 );
  twobit_lexical( 0, 1 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 3 );
  twobit_reg( 2 );
  ...
  twobit_setreg( 31 );
  twobit_reg( 4 );
  twobit_check( 3, 2, 31, 1693, compiled_block_1_1693 );
  twobit_reg( 3 );
  twobit_op2imm_455( fixnum(-128) ); /* >=:fix:fix */
  twobit_setreg( 4 );
  twobit_lexical( 0, 1 );
  ...
  twobit_check( 3, 2, 31, 1693, compiled_block_1_1693 );
  twobit_lexical( 0, 1 );
  twobit_op3_97( 2, 3 ); /* bytevector-like-set! */
  twobit_reg( 2 );
  twobit_op2imm_520( fixnum(1) ); /* +:idx:idx */
  twobit_setreg( 2 );
  twobit_branch( 1685, compiled_block_1_1685 );
  twobit_label( 1693, compiled_block_1_1693 );
  twobit_trap( 31, 2, 3, 71 );
  twobit_label( 1692, compiled_block_1_1692 );
  twobit_trap( 31, 2, 0, 70 );
...
static RTYPE compiled_start_1_70( CONT_PARAMS ) {
  ...
  twobit_store( 0, 0 );
  twobit_store( 1, 1 );
  twobit_lambda( compiled_start_1_106, 2, 0 );
  twobit_setreg( 1 );
  twobit_global( 3 ); /*  map~1pxGHH~1463 */
  twobit_setrtn( 1700, compiled_block_1_1700 );
  twobit_invoke( 2 );
  ...
  twobit_load( 1, 1 );
  twobit_reg( 4 );
  twobit_setrtn( 1702, compiled_block_1_1702 );
  twobit_invoke( 2 );
  twobit_label( 1702, compiled_block_1_1702 );
  twobit_load( 0, 0 );
  twobit_setreg( 1 );
  twobit_global( 5 ); /* bytevector-copy */
  ...
  twobit_reg( 4 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 4, 0, 0, 1704, compiled_block_1_1704 );
  twobit_reg( 4 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 3 );
  twobit_movereg( 4, 2 );
  twobit_movereg( 3, 1 );
  twobit_lambda( compiled_start_1_107, 7, 2 );
  twobit_setreg( 1 );
  twobit_load( 2, 2 );
  twobit_global( 8 ); /*  for-each~1pxGHH~1464 */
...
static RTYPE compiled_start_1_107( CONT_PARAMS ) {
  ...
  twobit_reg( 1 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 1, 0, 0, 1707, compiled_block_1_1707 );
  twobit_reg( 1 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 4 );
  twobit_lexical( 0, 1 );
  ...
  twobit_imm_const( TRUE_CONST ); /* #t */
  twobit_skip( 1710, compiled_block_1_1710 );
  ...
  twobit_const( 1 );
  twobit_skip( 1714, compiled_block_1_1714 );
  ...
  twobit_reg( 3 );
  twobit_op2_branchf_623( 2, 108, compiled_temp_1_108, 1718, compiled_block_1_1718 ); /* internal:branchf-= */
  twobit_op1_3(); /* unspecified */
  twobit_return();
  ...
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 4 );
  twobit_reg_op2_check_655(reg(3),reg(4),1719,compiled_block_1_1719); /* internal:check-<:fix:fix with (3 1 0) */
  twobit_reg( 1 );
  twobit_op2_96( 3 ); /* bytevector-like-ref */
  twobit_op1_33(); /* fxlognot */
  twobit_setreg( 4 );
  ...
  twobit_setreg( 30 );
  twobit_reg( 31 );
  twobit_check( 3, 30, 0, 1720, compiled_block_1_1720 );
  twobit_lexical( 0, 2 );
  twobit_op2_96( 3 ); /* bytevector-like-ref */
  twobit_op2_71( 4 ); /* fxlogand */
  twobit_setreg( 31 );
  ...
  twobit_setreg( 30 );
  twobit_reg( 4 );
  twobit_check( 31, 3, 30, 1721, compiled_block_1_1721 );
  twobit_reg( 31 );
  twobit_op2imm_452( fixnum(256) ); /* <:fix:fix */
  twobit_setreg( 4 );
  twobit_lexical( 0, 2 );
  ...
  twobit_op2imm_520( fixnum(1) ); /* +:idx:idx */
  twobit_setreg( 3 );
  twobit_branch( 1705, compiled_block_1_1705 );
...
static RTYPE compiled_start_1_72( CONT_PARAMS ) {
  ...
  twobit_argsge( 0 );
  twobit_reg( 1 );
  twobit_op1_branchf_610( 1728, compiled_block_1_1728 ); /* internal:branchf-null? */
  twobit_lexical( 0, 4 );
  twobit_op1_54(); /* cell-ref */
  twobit_return();
  twobit_label( 1728, compiled_block_1_1728 );
  twobit_reg_op1_check_652(reg(1),1729,compiled_block_1_1729); /* internal:check-pair? with (1 0 0) */
  twobit_reg( 1 );
  twobit_op1_405(); /* cdr:pair */
  twobit_op1_branchf_610( 1731, compiled_block_1_1731 ); /* internal:branchf-null? */
  twobit_reg( 1 );
  twobit_op1_404(); /* car:pair */
  twobit_return();
  ...
  twobit_store( 0, 0 );
  twobit_movereg( 1, 2 );
  twobit_lambda( compiled_start_1_104, 2, 0 );
  twobit_setreg( 1 );
  twobit_global( 3 ); /*  map~1pxGHH~1463 */
  ...
  twobit_op2_45( 3 ); /* bytevector-fill! */
  twobit_movereg( 4, 1 );
  twobit_lambda( compiled_start_1_105, 8, 1 );
  twobit_setreg( 1 );
  twobit_load( 2, 1 );
  twobit_global( 9 ); /*  for-each~1pxGHH~1464 */
...
static RTYPE compiled_start_1_105( CONT_PARAMS ) {
  ...
  twobit_reg( 1 );
  twobit_op1_43(); /* bytevector? */
  twobit_check( 1, 0, 0, 1738, compiled_block_1_1738 );
  twobit_reg( 1 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 2 );
  twobit_imm_const( fixnum(0) ); /* 0 */
  ...
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 4 );
  twobit_reg_op2_check_655(reg(3),reg(4),1742,compiled_block_1_1742); /* internal:check-<:fix:fix with (3 1 0) */
  twobit_reg( 1 );
  twobit_op2_96( 3 ); /* bytevector-like-ref */
  twobit_setreg( 4 );
  twobit_lexical( 0, 1 );
  ...
  twobit_setreg( 30 );
  twobit_reg( 31 );
  twobit_check( 3, 30, 0, 1743, compiled_block_1_1743 );
  twobit_lexical( 0, 1 );
  twobit_op1_102(); /* bytevector-like-length */
  twobit_setreg( 31 );
  twobit_reg( 3 );
  ...
  twobit_setreg( 30 );
  twobit_reg( 4 );
  twobit_check( 31, 3, 30, 1744, compiled_block_1_1744 );
  twobit_reg( 31 );
  twobit_op2imm_455( fixnum(-128) ); /* >=:fix:fix */
  twobit_setreg( 4 );
  twobit_lexical( 0, 1 );
...
static RTYPE compiled_start_1_75( CONT_PARAMS ) {
  ...
  twobit_save( 0 );
  twobit_store( 0, 0 );
  twobit_global( 1 ); /* char-general-category */
  ...
  twobit_setreg( 3 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 3, 1759, compiled_block_1_1759 ); /* internal:branchf-eq? */
  twobit_const( 3 );
  twobit_pop( 0 );
  twobit_return();
  ...
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1761, compiled_block_1_1761 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
  twobit_label( 1761, compiled_block_1_1761 );
  twobit_reg_op1_check_652(reg(3),1762,compiled_block_1_1762); /* internal:check-pair? with (3 0 0) */
  twobit_reg( 3 );
  twobit_op1_405(); /* cdr:pair */
  twobit_setreg( 3 );
  twobit_const( 5 );
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1764, compiled_block_1_1764 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
  ...
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1766, compiled_block_1_1766 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
  ...
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1768, compiled_block_1_1768 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
...
static RTYPE compiled_start_1_77( CONT_PARAMS ) {
  ...
  twobit_setreg( 3 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 3, 1776, compiled_block_1_1776 ); /* internal:branchf-eq? */
  twobit_const( 3 );
  twobit_pop( 0 );
  twobit_return();
  ...
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1778, compiled_block_1_1778 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
  twobit_label( 1778, compiled_block_1_1778 );
  twobit_reg_op1_check_652(reg(3),1779,compiled_block_1_1779); /* internal:check-pair? with (3 0 0) */
  twobit_reg( 3 );
  twobit_op1_405(); /* cdr:pair */
  twobit_setreg( 3 );
  twobit_const( 5 );
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1781, compiled_block_1_1781 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
  ...
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1783, compiled_block_1_1783 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
  ...
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1785, compiled_block_1_1785 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
  ...
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1787, compiled_block_1_1787 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
  ...
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1789, compiled_block_1_1789 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
...
static RTYPE compiled_start_1_78( CONT_PARAMS ) {
  ...
  twobit_setreg( 3 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 3, 1793, compiled_block_1_1793 ); /* internal:branchf-eq? */
  twobit_const( 3 );
  twobit_pop( 0 );
  twobit_return();
  ...
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1795, compiled_block_1_1795 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
  twobit_label( 1795, compiled_block_1_1795 );
  twobit_reg_op1_check_652(reg(3),1796,compiled_block_1_1796); /* internal:check-pair? with (3 0 0) */
  twobit_reg( 3 );
  twobit_op1_405(); /* cdr:pair */
  twobit_setreg( 3 );
  twobit_const( 5 );
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1798, compiled_block_1_1798 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
  ...
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1800, compiled_block_1_1800 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
...
static RTYPE compiled_start_1_79( CONT_PARAMS ) {
  ...
  twobit_setreg( 3 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 3, 1805, compiled_block_1_1805 ); /* internal:branchf-eq? */
  twobit_const( 3 );
  twobit_pop( 0 );
  twobit_return();
  ...
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1807, compiled_block_1_1807 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
  twobit_label( 1807, compiled_block_1_1807 );
  twobit_reg_op1_check_652(reg(3),1808,compiled_block_1_1808); /* internal:check-pair? with (3 0 0) */
  twobit_reg( 3 );
  twobit_op1_405(); /* cdr:pair */
  twobit_setreg( 3 );
  twobit_const( 5 );
  twobit_setreg( 2 );
  twobit_reg( 4 );
  twobit_op2_branchf_624( 2, 1810, compiled_block_1_1810 ); /* internal:branchf-eq? */
  twobit_reg( 3 );
  twobit_pop( 0 );
  twobit_return();
...
RTYPE twobit_thunk_13a2a62026ff5f08799949cf341f03e0_0(CONT_PARAMS) {
  RETURN_RTYPE(compiled_start_1_0(CONT_ACTUALS));
}
codeptr_t CDECL twobit_load_table[] = { 
  twobit_thunk_13a2a62026ff5f08799949cf341f03e0_0,
