/* Generated from /home/henchman/larcenytest/larceny-petit-Nightly-2017-08-06/larceny_src/lib/SRFI/srfi/14/latin-1.slfasl */
...
static RTYPE compiled_start_1_0( CONT_PARAMS ) {
  ...
  twobit_setglbl( 2 ); /*  char-set:ascii~1pxGHH~30142 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 3 ); /*  char-set:iso-control~1pxGHH~30141 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 4 ); /*  char-set:blank~1pxGHH~30140 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 5 ); /*  char-set:printing~1pxGHH~30139 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 6 ); /*  char-set:whitespace~1pxGHH~30138 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 7 ); /*  char-set:graphic~1pxGHH~30137 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 8 ); /*  char-set:symbol~1pxGHH~30136 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 9 ); /*  char-set:punctuation~1pxGHH~30135 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 10 ); /*  char-set:letter+digit~1pxGHH~30134 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 11 ); /*  char-set:hex-digit~1pxGHH~30133 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 12 ); /*  char-set:digit~1pxGHH~30132 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 13 ); /*  char-set:letter~1pxGHH~30131 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 14 ); /*  char-set:title-case~1pxGHH~30130 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 15 ); /*  char-set:upper-case~1pxGHH~30129 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 16 ); /*  char-set:lower-case~1pxGHH~30128 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 17 ); /*  char-set:full~1pxGHH~30127 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 18 ); /*  char-set:empty~1pxGHH~30126 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 19 ); /*  char-set-diff+intersection~1pxGHH~30125 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 20 ); /*  char-set-diff+intersection!~1pxGHH~30124 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 21 ); /*  char-set-xor~1pxGHH~30123 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 22 ); /*  char-set-xor!~1pxGHH~30122 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 23 ); /*  char-set-difference~1pxGHH~30121 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 24 ); /*  char-set-difference!~1pxGHH~30120 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 25 ); /*  char-set-intersection~1pxGHH~30119 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 26 ); /*  char-set-intersection!~1pxGHH~30118 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 27 ); /*  char-set-union~1pxGHH~30117 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 28 ); /*  char-set-union!~1pxGHH~30116 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 29 ); /*  char-set-complement!~1pxGHH~30115 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 30 ); /*  char-set-complement~1pxGHH~30114 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 31 ); /*  ->char-set~1pxGHH~30113 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 32 ); /*  char-set-filter!~1pxGHH~30112 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 33 ); /*  char-set-filter~1pxGHH~30111 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 34 ); /*  %char-set-filter~1pxGHH~30110 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 35 ); /*  ucs-range->char-set!~1pxGHH~30109 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 36 ); /*  ucs-range->char-set~1pxGHH~30108 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 37 ); /*  %ucs-range->char-set~1pxGHH~30107 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 38 ); /*  char-set->string~1pxGHH~30106 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 39 ); /*  string->char-set!~1pxGHH~30105 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 40 ); /*  string->char-set~1pxGHH~30104 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 41 ); /*  %string->char-set~1pxGHH~30103 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 42 ); /*  char-set->list~1pxGHH~30102 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 43 ); /*  list->char-set!~1pxGHH~30101 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 44 ); /*  list->char-set~1pxGHH~30100 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 45 ); /*  char-set~1pxGHH~30099 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 46 ); /*  %list->char-set~1pxGHH~30098 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 47 ); /*  char-set-unfold!~1pxGHH~30097 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 48 ); /*  char-set-unfold~1pxGHH~30096 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 49 ); /*  %char-set-unfold~1pxGHH~30095 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 50 ); /*  char-set-any~1pxGHH~30094 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 51 ); /*  char-set-every~1pxGHH~30093 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 52 ); /*  char-set-fold~1pxGHH~30092 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 53 ); /*  char-set-map~1pxGHH~30091 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 54 ); /*  char-set-for-each~1pxGHH~30090 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 55 ); /*  %char-set-cursor-next~1pxGHH~30089 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 56 ); /*  char-set-cursor-next~1pxGHH~30088 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 57 ); /*  char-set-ref~1pxGHH~30087 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 58 ); /*  end-of-char-set?~1pxGHH~30086 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 59 ); /*  char-set-cursor~1pxGHH~30085 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 60 ); /*  char-set-delete!~1pxGHH~30084 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 61 ); /*  char-set-delete~1pxGHH~30083 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 62 ); /*  char-set-adjoin!~1pxGHH~30082 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 63 ); /*  char-set-adjoin~1pxGHH~30081 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 64 ); /*  char-set-count~1pxGHH~30080 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 65 ); /*  char-set-size~1pxGHH~30079 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 66 ); /*  char-set-contains?~1pxGHH~30078 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 67 ); /*  char-set-hash~1pxGHH~30077 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 68 ); /*  char-set<=~1pxGHH~30076 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 69 ); /*  char-set=~1pxGHH~30075 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 70 ); /*  char-set-copy~1pxGHH~30074 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 71 ); /*  %set1!~1pxGHH~30073 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 72 ); /*  %set0!~1pxGHH~30072 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 73 ); /*  si=1?~1pxGHH~30071 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 74 ); /*  si=0?~1pxGHH~30070 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 75 ); /*  %char-set:bitv/check~1pxGHH~30069 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 76 ); /*  %default-base~1pxGHH~30068 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 77 ); /*  %char-set:empty~1pxGHH~30047 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 78 ); /*  char-set:bitv~1pxGHH~30046 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 79 ); /*  char-set?~1pxGHH~30045 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 80 ); /*  make-char-set~1pxGHH~30044 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 81 ); /*  :char-set~1pxGHH~30043 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 82 ); /*  error~1pxGHH~30038 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 83 ); /*  bitvector-set!~1pxGHH~30037 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 84 ); /*  bitvector-ref~1pxGHH~30036 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 85 ); /*  bitvector-length~1pxGHH~30035 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 86 ); /*  make-bitvector~1pxGHH~30034 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 87 ); /*  bitvector-minimized~1pxGHH~30033 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 88 ); /*  %char-set:maxsize-in-bytes~1pxGHH~30032 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 89 ); /*  %char-set:maxsize~1pxGHH~30031 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 90 ); /*  %char-set:minsize-in-bytes~1pxGHH~30030 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 91 ); /*  %char-set:minsize~1pxGHH~30029 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 92 ); /*  %excluded:max/8~1pxGHH~30028 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 93 ); /*  %excluded:min/8~1pxGHH~30027 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 94 ); /*  %unicode:limit~1pxGHH~30026 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 95 ); /*  %excluded:max~1pxGHH~30025 */
  twobit_global( 1 ); /* ex:unspecified */
  twobit_setglbl( 96 ); /*  %excluded:min~1pxGHH~30024 */
...
static RTYPE compiled_start_1_4( CONT_PARAMS ) {
  ...
  twobit_op1_16(); /* cdr */
  twobit_stack( 1 );
  twobit_setglbl( 1 ); /*  char-set?~1pxGHH~30045 */
  twobit_reg( 2 );
  twobit_setglbl( 2 ); /*  char-set-copy~1pxGHH~30074 */
  twobit_reg( 3 );
  twobit_setglbl( 3 ); /*  char-set=~1pxGHH~30075 */
  twobit_reg( 4 );
  twobit_setglbl( 4 ); /*  char-set<=~1pxGHH~30076 */
  twobit_reg( 5 );
  twobit_setglbl( 5 ); /*  char-set-hash~1pxGHH~30077 */
  twobit_reg( 6 );
  twobit_setglbl( 6 ); /*  char-set-contains?~1pxGHH~30078 */
  twobit_reg( 7 );
  twobit_setglbl( 7 ); /*  char-set-size~1pxGHH~30079 */
  twobit_reg( 8 );
  twobit_setglbl( 8 ); /*  char-set-count~1pxGHH~30080 */
  twobit_reg( 9 );
  twobit_setglbl( 9 ); /*  char-set-adjoin~1pxGHH~30081 */
  twobit_reg( 10 );
  twobit_setglbl( 10 ); /*  char-set-adjoin!~1pxGHH~30082 */
  twobit_reg( 11 );
  twobit_setglbl( 11 ); /*  char-set-delete~1pxGHH~30083 */
  twobit_reg( 12 );
  twobit_setglbl( 12 ); /*  char-set-delete!~1pxGHH~30084 */
  twobit_reg( 13 );
  twobit_setglbl( 13 ); /*  char-set-cursor~1pxGHH~30085 */
  twobit_reg( 14 );
  twobit_setglbl( 14 ); /*  end-of-char-set?~1pxGHH~30086 */
  twobit_reg( 15 );
  twobit_setglbl( 15 ); /*  char-set-ref~1pxGHH~30087 */
  twobit_reg( 16 );
  twobit_setglbl( 16 ); /*  char-set-cursor-next~1pxGHH~30088 */
  twobit_reg( 17 );
  twobit_setglbl( 17 ); /*  char-set-for-each~1pxGHH~30090 */
  twobit_reg( 18 );
  twobit_setglbl( 18 ); /*  char-set-map~1pxGHH~30091 */
  twobit_reg( 19 );
  twobit_setglbl( 19 ); /*  char-set-fold~1pxGHH~30092 */
  twobit_reg( 20 );
  twobit_setglbl( 20 ); /*  char-set-every~1pxGHH~30093 */
  twobit_reg( 21 );
  twobit_setglbl( 21 ); /*  char-set-any~1pxGHH~30094 */
  twobit_reg( 22 );
  twobit_setglbl( 22 ); /*  char-set-unfold~1pxGHH~30096 */
  twobit_reg( 23 );
  twobit_setglbl( 23 ); /*  char-set-unfold!~1pxGHH~30097 */
  twobit_reg( 24 );
  twobit_setglbl( 24 ); /*  char-set~1pxGHH~30099 */
  twobit_reg( 25 );
  twobit_setglbl( 25 ); /*  list->char-set~1pxGHH~30100 */
  twobit_reg( 26 );
  twobit_setglbl( 26 ); /*  list->char-set!~1pxGHH~30101 */
  twobit_reg( 27 );
  twobit_setglbl( 27 ); /*  char-set->list~1pxGHH~30102 */
  twobit_reg( 28 );
  twobit_setglbl( 28 ); /*  string->char-set~1pxGHH~30104 */
  twobit_reg( 29 );
  twobit_setglbl( 29 ); /*  string->char-set!~1pxGHH~30105 */
  twobit_reg( 30 );
  twobit_setglbl( 30 ); /*  char-set->string~1pxGHH~30106 */
  twobit_stack( 2 );
  twobit_setglbl( 31 ); /*  ucs-range->char-set~1pxGHH~30108 */
  twobit_stack( 3 );
  twobit_setglbl( 32 ); /*  ucs-range->char-set!~1pxGHH~30109 */
  twobit_stack( 4 );
  twobit_setglbl( 33 ); /*  char-set-filter~1pxGHH~30111 */
  twobit_stack( 5 );
  twobit_setglbl( 34 ); /*  char-set-filter!~1pxGHH~30112 */
  twobit_stack( 6 );
  twobit_setglbl( 35 ); /*  ->char-set~1pxGHH~30113 */
  twobit_stack( 7 );
  twobit_setglbl( 36 ); /*  char-set-complement~1pxGHH~30114 */
  twobit_stack( 8 );
  twobit_setglbl( 37 ); /*  char-set-complement!~1pxGHH~30115 */
  twobit_stack( 9 );
  twobit_setglbl( 38 ); /*  char-set-union!~1pxGHH~30116 */
  twobit_stack( 10 );
  twobit_setglbl( 39 ); /*  char-set-union~1pxGHH~30117 */
  twobit_stack( 11 );
  twobit_setglbl( 40 ); /*  char-set-intersection!~1pxGHH~30118 */
  twobit_stack( 12 );
  twobit_setglbl( 41 ); /*  char-set-intersection~1pxGHH~30119 */
  twobit_stack( 13 );
  twobit_setglbl( 42 ); /*  char-set-difference!~1pxGHH~30120 */
  twobit_stack( 14 );
  twobit_setglbl( 43 ); /*  char-set-difference~1pxGHH~30121 */
  twobit_stack( 15 );
  twobit_setglbl( 44 ); /*  char-set-xor!~1pxGHH~30122 */
  twobit_stack( 16 );
  twobit_setglbl( 45 ); /*  char-set-xor~1pxGHH~30123 */
  twobit_stack( 17 );
  twobit_setglbl( 46 ); /*  char-set-diff+intersection!~1pxGHH~30124 */
  twobit_stack( 18 );
  twobit_setglbl( 47 ); /*  char-set-diff+intersection~1pxGHH~30125 */
  twobit_stack( 19 );
  twobit_setglbl( 48 ); /*  char-set:empty~1pxGHH~30126 */
  twobit_stack( 20 );
  twobit_setglbl( 49 ); /*  char-set:full~1pxGHH~30127 */
  twobit_stack( 21 );
  twobit_setglbl( 50 ); /*  char-set:lower-case~1pxGHH~30128 */
  twobit_stack( 22 );
  twobit_setglbl( 51 ); /*  char-set:upper-case~1pxGHH~30129 */
  twobit_stack( 23 );
  twobit_setglbl( 52 ); /*  char-set:title-case~1pxGHH~30130 */
  twobit_stack( 24 );
  twobit_setglbl( 53 ); /*  char-set:letter~1pxGHH~30131 */
  twobit_stack( 25 );
  twobit_setglbl( 54 ); /*  char-set:digit~1pxGHH~30132 */
  twobit_stack( 26 );
  twobit_setglbl( 55 ); /*  char-set:hex-digit~1pxGHH~30133 */
  twobit_stack( 27 );
  twobit_setglbl( 56 ); /*  char-set:letter+digit~1pxGHH~30134 */
  twobit_stack( 28 );
  twobit_setglbl( 57 ); /*  char-set:punctuation~1pxGHH~30135 */
  twobit_stack( 29 );
  twobit_setglbl( 58 ); /*  char-set:symbol~1pxGHH~30136 */
  twobit_stack( 30 );
  twobit_setglbl( 59 ); /*  char-set:graphic~1pxGHH~30137 */
  twobit_stack( 31 );
  twobit_setglbl( 60 ); /*  char-set:whitespace~1pxGHH~30138 */
  twobit_stack( 32 );
  twobit_setglbl( 61 ); /*  char-set:printing~1pxGHH~30139 */
  twobit_stack( 33 );
  twobit_setglbl( 62 ); /*  char-set:blank~1pxGHH~30140 */
  twobit_stack( 34 );
  twobit_setglbl( 63 ); /*  char-set:iso-control~1pxGHH~30141 */
  twobit_stack( 35 );
  twobit_setglbl( 64 ); /*  char-set:ascii~1pxGHH~30142 */
...
RTYPE twobit_thunk_e3fb06d0b4b2bf6747ec27e7f06831cf_0(CONT_PARAMS) {
  RETURN_RTYPE(compiled_start_1_0(CONT_ACTUALS));
}
codeptr_t CDECL twobit_load_table[] = { 
  twobit_thunk_e3fb06d0b4b2bf6747ec27e7f06831cf_0,
